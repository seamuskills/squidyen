...
public class FallbackResourceManager implements IResourceManager {
   ...
   public Collection<ResourceLocation> func_230231_a_(ResourceLocation p_230231_1_, Predicate<String> p_230231_2_) {
      return (Collection<ResourceLocation>)(Objects.equals(p_230231_1_.getNamespace(), this.namespace) ? this.getAllResourceLocations(p_230231_1_.getPath(), p_230231_2_) : ImmutableSet.of());
   }
