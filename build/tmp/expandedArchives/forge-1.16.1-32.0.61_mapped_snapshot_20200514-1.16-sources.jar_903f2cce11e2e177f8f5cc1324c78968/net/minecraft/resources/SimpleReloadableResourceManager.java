...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
   ...
   public Collection<ResourceLocation> func_230231_a_(ResourceLocation p_230231_1_, Predicate<String> p_230231_2_) {
      IResourceManager iresourcemanager = this.namespaceResourceManagers.get(p_230231_1_.getNamespace());
      return (Collection<ResourceLocation>)(iresourcemanager != null ? iresourcemanager.getAllResourceLocations(p_230231_1_.getPath(), p_230231_2_) : ImmutableSet.of());
   }
