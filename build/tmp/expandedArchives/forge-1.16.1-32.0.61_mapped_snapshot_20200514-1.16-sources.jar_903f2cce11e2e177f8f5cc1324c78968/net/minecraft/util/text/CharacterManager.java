...
public class CharacterManager {
   ...
   public List<ITextProperties> func_238362_b_(ITextProperties p_238362_1_, int p_238362_2_, Style p_238362_3_) {
      return this.func_241570_a_(p_238362_1_, p_238362_2_, p_238362_3_, (ITextProperties)null);
   }

   public List<ITextProperties> func_241570_a_(ITextProperties p_241570_1_, int p_241570_2_, Style p_241570_3_, @Nullable ITextProperties p_241570_4_) {
      List<ITextProperties> list = Lists.newArrayList();
      List<CharacterManager.StyleOverridingTextComponent> list1 = Lists.newArrayList();
      p_241570_1_.func_230439_a_((p_238355_1_, p_238355_2_) -> {
         if (!p_238355_2_.isEmpty()) {
            list1.add(new CharacterManager.StyleOverridingTextComponent(p_238355_2_, p_238355_1_));
         }

         return Optional.empty();
      }, p_241570_3_);
      CharacterManager.SubstyledText charactermanager$substyledtext = new CharacterManager.SubstyledText(list1);
      boolean flag = true;
      boolean flag1 = false;
      boolean flag2 = false;
      ...
      while(flag) {
         flag = false;
         CharacterManager.MultilineProcessor charactermanager$multilineprocessor = new CharacterManager.MultilineProcessor((float)p_241570_2_);
         ...
         for(CharacterManager.StyleOverridingTextComponent charactermanager$styleoverridingtextcomponent : charactermanager$substyledtext.field_238369_a_) {
            boolean flag3 = TextProcessing.func_238340_a_(charactermanager$styleoverridingtextcomponent.field_238391_a_, 0, charactermanager$styleoverridingtextcomponent.field_238392_d_, p_241570_3_, charactermanager$multilineprocessor);
            if (!flag3) {
               ...
               list.add(this.func_241571_a_(itextproperties, flag2, p_241570_4_));
               flag2 = !flag4;
               flag = true;
               break;
            }
      ...
      if (itextproperties1 != null) {
         list.add(this.func_241571_a_(itextproperties1, flag2, p_241570_4_));
      } else if (flag1) {
         list.add(ITextProperties.field_240651_c_);
      }

      return list;
   }

   private ITextProperties func_241571_a_(ITextProperties p_241571_1_, boolean p_241571_2_, ITextProperties p_241571_3_) {
      return p_241571_2_ && p_241571_3_ != null ? ITextProperties.func_240655_a_(p_241571_3_, p_241571_1_) : p_241571_1_;
   }
   ...
   @OnlyIn(Dist.CLIENT)
   class MultilineProcessor implements TextProcessing.ICharacterConsumer {
      ...
      public boolean onChar(int p_onChar_1_, Style p_onChar_2_, int p_onChar_3_) {
         int i = p_onChar_1_ + this.field_238385_j_;
         switch(p_onChar_3_) {
         case 10:
            return this.func_238388_a_(i, p_onChar_2_);
         case 32:
            this.field_238382_g_ = i;
            this.field_238383_h_ = p_onChar_2_;
         default:
            float f = CharacterManager.this.field_238347_a_.getWidth(p_onChar_3_, p_onChar_2_);
            this.field_238381_f_ += f;
            if (this.field_238380_e_ && this.field_238381_f_ > this.field_238377_b_) {
               return this.field_238382_g_ != -1 ? this.func_238388_a_(this.field_238382_g_, this.field_238383_h_) : this.func_238388_a_(i, p_onChar_2_);
            } else {
               this.field_238380_e_ |= f != 0.0F;
               this.field_238384_i_ = i + Character.charCount(p_onChar_3_);
               return true;
            }
         }
      }
   ...
   @OnlyIn(Dist.CLIENT)
   class StringWidthProcessor implements TextProcessing.ICharacterConsumer {
      ...
      public boolean onChar(int p_onChar_1_, Style p_onChar_2_, int p_onChar_3_) {
         this.field_238396_b_ -= CharacterManager.this.field_238347_a_.getWidth(p_onChar_3_, p_onChar_2_);
         if (this.field_238396_b_ >= 0.0F) {
            this.field_238397_c_ = p_onChar_1_ + Character.charCount(p_onChar_3_);
            return true;
         } else {
            return false;
         }
