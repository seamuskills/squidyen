...
public class DataFixesManager {
   ...
   private static void addFixers(DataFixerBuilder builder) {
      ...
      builder.addFixer(new AddNewChoices(schema94, "Added Bee and Bee Stinger", TypeReferences.ENTITY));
      builder.addFixer(new AddNewChoices(schema94, "Add beehive", TypeReferences.BLOCK_ENTITY));
      builder.addFixer(new RecipeRenamer(schema94, false, "Rename sugar recipe", func_241299_a_("minecraft:sugar", "sugar_from_sugar_cane")));
      builder.addFixer(new AdvancementRenamer(schema94, false, "Rename sugar recipe advancement", func_241299_a_("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
      Schema schema95 = builder.addSchema(2202, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new BiomeIdFix(schema95, false));
      Schema schema96 = builder.addSchema(2209, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(ItemRename.create(schema96, "Rename bee_hive item to beehive", func_241299_a_("minecraft:bee_hive", "minecraft:beehive")));
      builder.addFixer(new RenameBeehivePointOfInterest(schema96));
      builder.addFixer(BlockRename.create(schema96, "Rename bee_hive block to beehive", func_241299_a_("minecraft:bee_hive", "minecraft:beehive")));
      Schema schema97 = builder.addSchema(2211, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new StructureReferenceFix(schema97, false));
      Schema schema98 = builder.addSchema(2218, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new PointOfInterestRebuild(schema98, false));
      Schema schema99 = builder.addSchema(2501, V2501::new);
      builder.addFixer(new FurnaceRecipes(schema99, true));
      Schema schema100 = builder.addSchema(2502, V2502::new);
      builder.addFixer(new AddNewChoices(schema100, "Added Hoglin", TypeReferences.ENTITY));
      Schema schema101 = builder.addSchema(2503, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new WallProperty(schema101, false));
      builder.addFixer(new AdvancementRenamer(schema101, false, "Composter category change", func_241299_a_("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
      Schema schema102 = builder.addSchema(2505, V2505::new);
      builder.addFixer(new AddNewChoices(schema102, "Added Piglin", TypeReferences.ENTITY));
      builder.addFixer(new MemoryExpiry(schema102, "minecraft:villager"));
      Schema schema103 = builder.addSchema(2508, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(ItemRename.create(schema103, "Renamed fungi items to fungus", func_241301_a_(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      builder.addFixer(BlockRename.create(schema103, "Renamed fungi blocks to fungus", func_241301_a_(ImmutableMap.of("minecraft:warped_fungi", "minecraft:warped_fungus", "minecraft:crimson_fungi", "minecraft:crimson_fungus"))));
      Schema schema104 = builder.addSchema(2509, V2509::new);
      builder.addFixer(new ZombifiedPiglinRename(schema104));
      builder.addFixer(ItemRename.create(schema104, "Rename zombie pigman egg item", func_241301_a_(ZombifiedPiglinRename.field_233242_a_)));
      Schema schema105 = builder.addSchema(2511, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new ProjectileOwner(schema105));
      Schema schema106 = builder.addSchema(2514, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new EntityUUID(schema106));
      builder.addFixer(new BlockEntityUUID(schema106));
      builder.addFixer(new PlayerUUID(schema106));
      builder.addFixer(new LevelUUID(schema106));
      builder.addFixer(new SavedDataUUID(schema106));
      builder.addFixer(new ItemStackUUID(schema106));
      Schema schema107 = builder.addSchema(2516, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new Gossip(schema107, "minecraft:villager"));
      builder.addFixer(new Gossip(schema107, "minecraft:zombie_villager"));
      Schema schema108 = builder.addSchema(2518, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new JigsawProperties(schema108, false));
      builder.addFixer(new JigsawRotation(schema108, false));
      Schema schema109 = builder.addSchema(2519, V2519::new);
      builder.addFixer(new AddNewChoices(schema109, "Added Strider", TypeReferences.ENTITY));
      Schema schema110 = builder.addSchema(2522, V2522::new);
      builder.addFixer(new AddNewChoices(schema110, "Added Zoglin", TypeReferences.ENTITY));
      Schema schema111 = builder.addSchema(2523, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new AttributesFix(schema111));
      Schema schema112 = builder.addSchema(2527, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new BitStorageAlignFix(schema112));
      Schema schema113 = builder.addSchema(2528, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(ItemRename.create(schema113, "Rename soul fire torch and soul fire lantern", func_241301_a_(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      builder.addFixer(BlockRename.create(schema113, "Rename soul fire torch and soul fire lantern", func_241301_a_(ImmutableMap.of("minecraft:soul_fire_torch", "minecraft:soul_torch", "minecraft:soul_fire_wall_torch", "minecraft:soul_wall_torch", "minecraft:soul_fire_lantern", "minecraft:soul_lantern"))));
      Schema schema114 = builder.addSchema(2529, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new StriderGravity(schema114, false));
      Schema schema115 = builder.addSchema(2531, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new RedstoneConnections(schema115));
      Schema schema116 = builder.addSchema(2533, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new VillagerFollowRange(schema116));
      Schema schema117 = builder.addSchema(2535, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new ShulkerRotation(schema117));
      Schema schema118 = builder.addSchema(2550, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new WorldGenSettings(schema118));
      Schema schema119 = builder.addSchema(2551, V2551::new);
      builder.addFixer(new WriteAndReadDataFix(schema119, "add types to WorldGenData", TypeReferences.field_233375_y_));
      Schema schema120 = builder.addSchema(2552, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new BiomeName(schema120, false, "Nether biome rename", ImmutableMap.of("minecraft:nether", "minecraft:nether_wastes")));
      Schema schema121 = builder.addSchema(2553, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new BiomeRenames(schema121, false));
      Schema schema122 = builder.addSchema(2558, NAMESPACED_SCHEMA_FACTORY);
      builder.addFixer(new MissingDimensionFix(schema122, false));
      builder.addFixer(new SwapHandsFix(schema122, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
   }
