...
public abstract class AbstractOption {
   public static final SliderPercentageOption BIOME_BLEND_RADIUS = new SliderPercentageOption("options.biomeBlendRadius", 0.0D, 7.0D, 1.0F, (p_216607_0_) -> {
      ...
      int i = (int)d0 * 2 + 1;
      return iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.biomeBlendRadius." + i));
   });
   public static final SliderPercentageOption CHAT_HEIGHT_FOCUSED = new SliderPercentageOption("options.chat.height.focused", 0.0D, 1.0D, 0.0F, (p_216587_0_) -> {
      ...
      return p_216642_1_.func_238238_a_().func_240702_b_(NewChatGui.calculateChatboxHeight(d0) + "px");
   });
   public static final SliderPercentageOption CHAT_HEIGHT_UNFOCUSED = new SliderPercentageOption("options.chat.height.unfocused", 0.0D, 1.0D, 0.0F, (p_216611_0_) -> {
      ...
      return p_216604_1_.func_238238_a_().func_240702_b_(NewChatGui.calculateChatboxHeight(d0) + "px");
   });
   public static final SliderPercentageOption CHAT_OPACITY = new SliderPercentageOption("options.chat.opacity", 0.0D, 1.0D, 0.0F, (p_216649_0_) -> {
      ...
      return p_216592_1_.func_238238_a_().func_240702_b_((int)(d0 * 90.0D + 10.0D) + "%");
   });
   public static final SliderPercentageOption CHAT_SCALE = new SliderPercentageOption("options.chat.scale", 0.0D, 1.0D, 0.0F, (p_216591_0_) -> {
      ...
      return d0 == 0.0D ? iformattabletextcomponent.func_230529_a_(DialogTexts.field_240631_b_) : iformattabletextcomponent.func_240702_b_((int)(d0 * 100.0D) + "%");
   });
   public static final SliderPercentageOption CHAT_WIDTH = new SliderPercentageOption("options.chat.width", 0.0D, 1.0D, 0.0F, (p_216601_0_) -> {
      ...
      return p_216673_1_.func_238238_a_().func_240702_b_(NewChatGui.calculateChatboxWidth(d0) + "px");
   });
   public static final SliderPercentageOption field_238235_g_ = new SliderPercentageOption("options.chat.line_spacing", 0.0D, 1.0D, 0.0F, (p_238287_0_) -> {
      ...
      return p_238297_1_.func_238238_a_().func_240702_b_((int)(p_238297_1_.normalizeValue(p_238297_1_.get(p_238297_0_)) * 100.0D) + "%");
   });
   ...
   public static final SliderPercentageOption FOV = new SliderPercentageOption("options.fov", 30.0D, 110.0D, 1.0F, (p_216655_0_) -> {
      ...
      if (d0 == 70.0D) {
         return iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.fov.min"));
      } else {
         return d0 == p_216590_1_.getMaxValue() ? iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.fov.max")) : iformattabletextcomponent.func_240702_b_(Integer.toString((int)d0));
      }
   });
   public static final SliderPercentageOption FRAMERATE_LIMIT = new SliderPercentageOption("options.framerateLimit", 10.0D, 260.0D, 10.0F, (p_216672_0_) -> {
      ...
      return d0 == p_216645_1_.getMaxValue() ? iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.framerateLimit.max")) : iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.framerate", (int)d0));
   });
   public static final SliderPercentageOption GAMMA = new SliderPercentageOption("options.gamma", 0.0D, 1.0D, 0.0F, (p_216636_0_) -> {
      ...
      if (d0 == 0.0D) {
         return iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.gamma.min"));
      } else {
         return d0 == 1.0D ? iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.gamma.max")) : iformattabletextcomponent.func_240702_b_("+" + (int)(d0 * 100.0D) + "%");
      }
   });
   ...
   public static final SliderPercentageOption MOUSE_WHEEL_SENSITIVITY = new SliderMultiplierOption("options.mouseWheelSensitivity", 0.01D, 10.0D, 0.01F, (p_216581_0_) -> {
      ...
      return p_216675_1_.func_238238_a_().func_240702_b_(String.format("%.2f", p_216675_1_.denormalizeValue(d0)));
   });
   ...
   public static final SliderPercentageOption RENDER_DISTANCE = new SliderPercentageOption("options.renderDistance", 2.0D, 16.0D, 1.0F, (p_216658_0_) -> {
      ...
      return p_216664_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent("options.chunks", (int)d0));
   });
   ...
   public static final SliderPercentageOption SENSITIVITY = new SliderPercentageOption("options.sensitivity", 0.0D, 1.0D, 0.0F, (p_216654_0_) -> {
      ...
      if (d0 == 0.0D) {
         return iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.sensitivity.min"));
      } else {
         return d0 == 1.0D ? iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.sensitivity.max")) : iformattabletextcomponent.func_240702_b_((int)(d0 * 200.0D) + "%");
      }
   });
   public static final SliderPercentageOption ACCESSIBILITY_TEXT_BACKGROUND_OPACITY = new SliderPercentageOption("options.accessibility.text_background_opacity", 0.0D, 1.0D, 0.0F, (p_216597_0_) -> {
      ...
      return p_216626_1_.func_238238_a_().func_240702_b_((int)(p_216626_1_.normalizeValue(p_216626_1_.get(p_216626_0_)) * 100.0D) + "%");
   });
   public static final IteratableOption AO = new IteratableOption("options.ao", (p_216653_0_, p_216653_1_) -> {
      ...
      return p_216630_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216630_0_.ambientOcclusionStatus.getResourceKey()));
   });
   public static final IteratableOption ATTACK_INDICATOR = new IteratableOption("options.attackIndicator", (p_216615_0_, p_216615_1_) -> {
      ...
      return p_216609_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216609_0_.attackIndicator.getResourceKey()));
   });
   public static final IteratableOption CHAT_VISIBILITY = new IteratableOption("options.chat.visibility", (p_216640_0_, p_216640_1_) -> {
      ...
      return p_216598_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216598_0_.chatVisibility.getResourceKey()));
   });
   ...
   public static final IteratableOption GRAPHICS = new IteratableOption("options.graphics", (p_216577_0_, p_216577_1_) -> {
      ...
      return p_216633_0_.field_238330_f_ == GraphicsFanciness.FABULOUS ? p_216633_1_.func_238238_a_().func_230529_a_((new StringTextComponent("")).func_230529_a_(translationtextcomponent).func_240699_a_(TextFormatting.ITALIC)) : p_216633_1_.func_238238_a_().func_230529_a_(translationtextcomponent);
   });
   public static final IteratableOption GUI_SCALE = new IteratableOption("options.guiScale", (p_216674_0_, p_216674_1_) -> {
      ...
      return p_216668_0_.guiScale == 0 ? iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.guiScale.auto")) : iformattabletextcomponent.func_240702_b_(Integer.toString(p_216668_0_.guiScale));
   });
   public static final IteratableOption MAIN_HAND = new IteratableOption("options.mainHand", (p_216584_0_, p_216584_1_) -> {
      ...
      return p_216596_1_.func_238238_a_().func_230529_a_(p_216596_0_.mainHand.func_233609_b_());
   });
   public static final IteratableOption NARRATOR = new IteratableOption("options.narrator", (p_216648_0_, p_216648_1_) -> {
      ...
      return NarratorChatListener.INSTANCE.isActive() ? p_216632_1_.func_238238_a_().func_230529_a_(p_216632_0_.narrator.func_238233_b_()) : p_216632_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent("options.narrator.notavailable"));
   });
   public static final IteratableOption PARTICLES = new IteratableOption("options.particles", (p_216622_0_, p_216622_1_) -> {
      ...
      return p_216616_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216616_0_.particles.getResourceKey()));
   });
   public static final IteratableOption RENDER_CLOUDS = new IteratableOption("options.renderClouds", (p_216605_0_, p_216605_1_) -> {
      ...
      return p_216602_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216602_0_.cloudOption.getKey()));
   });
   public static final IteratableOption ACCESSIBILITY_TEXT_BACKGROUND = new IteratableOption("options.accessibility.text_background", (p_216665_0_, p_216665_1_) -> {
      ...
      return p_216639_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216639_0_.accessibilityTextBackground ? "options.accessibility.text_background.chat" : "options.accessibility.text_background.everywhere"));
   });
   ...
   public static final IteratableOption SNEAK = new IteratableOption("key.sneak", (p_228043_0_, p_228043_1_) -> {
      ...
      return p_228041_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_228041_0_.toggleCrouch ? "options.key.toggle" : "options.key.hold"));
   });
   public static final IteratableOption SPRINT = new IteratableOption("key.sprint", (p_228039_0_, p_228039_1_) -> {
      ...
      return p_228037_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_228037_0_.toggleSprint ? "options.key.toggle" : "options.key.hold"));
   });
   ...
   public IFormattableTextComponent func_238238_a_() {
      return (new TranslationTextComponent(this.translationKey)).func_240702_b_(": ");
   }
