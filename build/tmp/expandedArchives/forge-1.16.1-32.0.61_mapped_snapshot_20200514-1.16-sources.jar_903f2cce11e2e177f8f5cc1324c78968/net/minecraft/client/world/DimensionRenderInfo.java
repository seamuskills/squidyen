...
public abstract class DimensionRenderInfo {
   private static final Object2ObjectMap<RegistryKey<DimensionType>, DimensionRenderInfo> field_239208_a_ = Util.make(new Object2ObjectArrayMap<>(), (p_239214_0_) -> {
      ...
      p_239214_0_.put(DimensionType.field_235999_c_, dimensionrenderinfo$overworld);
      p_239214_0_.put(DimensionType.field_236000_d_, new DimensionRenderInfo.Nether());
      p_239214_0_.put(DimensionType.field_236001_e_, new DimensionRenderInfo.End());
   });
   ...
   public static DimensionRenderInfo func_239215_a_(Optional<RegistryKey<DimensionType>> p_239215_0_) {
      return field_239208_a_.get(p_239215_0_.orElse(DimensionType.field_235999_c_));
   }
