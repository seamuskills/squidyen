...
public abstract class EntityRenderer<T extends Entity> {
   ...
   protected void renderName(T entityIn, ITextComponent displayNameIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      ...
      if (!(d0 > 4096.0D)) {
         ...
         fontrenderer.func_238416_a_(displayNameIn, f2, (float)i, 553648127, false, matrix4f, bufferIn, flag, j, packedLightIn);
         if (flag) {
            fontrenderer.func_238416_a_(displayNameIn, f2, (float)i, -1, false, matrix4f, bufferIn, false, 0, packedLightIn);
         }
