...
public class PiglinRenderer extends BipedRenderer<MobEntity, PiglinModel<MobEntity>> {
   private static final ResourceLocation field_239393_a_ = new ResourceLocation("textures/entity/piglin/piglin.png");
   ...
   public ResourceLocation getEntityTexture(MobEntity entity) {
      return entity instanceof PiglinEntity ? field_239393_a_ : field_239394_g_;
   }

   protected boolean func_230495_a_(MobEntity p_230495_1_) {
      return p_230495_1_ instanceof PiglinEntity && ((PiglinEntity)p_230495_1_).func_234423_eL_();
   }
}
