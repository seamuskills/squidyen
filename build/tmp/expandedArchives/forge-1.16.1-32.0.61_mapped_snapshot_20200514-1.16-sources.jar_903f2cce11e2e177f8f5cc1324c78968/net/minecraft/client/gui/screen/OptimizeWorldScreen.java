...
public class OptimizeWorldScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      int l = k + 10;
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.optimizer.getStatusText(), this.field_230708_k_ / 2, k - 9 - 2, 10526880);
      if (this.optimizer.getTotalChunks() > 0) {
         func_238467_a_(p_230430_1_, i - 1, k - 1, j + 1, l + 1, -16777216);
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("optimizeWorld.info.converted", this.optimizer.getConverted()), i, 40, 10526880);
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("optimizeWorld.info.skipped", this.optimizer.getSkipped()), i, 40 + 9 + 3, 10526880);
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("optimizeWorld.info.total", this.optimizer.getTotalChunks()), i, 40 + (9 + 3) * 2, 10526880);
         int i1 = 0;
         ...
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, k1 + " / " + this.optimizer.getTotalChunks(), this.field_230708_k_ / 2, k + 2 * 9 + 2, 10526880);
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, MathHelper.floor(this.optimizer.getTotalProgress() * 100.0F) + "%", this.field_230708_k_ / 2, k + (l - k) / 2 - 9 / 2, 10526880);
      }
