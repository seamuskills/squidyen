...
public class BeaconScreen extends ContainerScreen<BeaconContainer> {
   ...
   protected void func_230451_b_(MatrixStack p_230451_1_, int p_230451_2_, int p_230451_3_) {
      this.func_238471_a_(p_230451_1_, this.field_230712_o_, I18n.format("block.minecraft.beacon.primary"), 62, 10, 14737632);
      this.func_238471_a_(p_230451_1_, this.field_230712_o_, I18n.format("block.minecraft.beacon.secondary"), 169, 10, 14737632);
   ...
   class PowerButton extends BeaconScreen.Button {
      ...
      public void func_230443_a_(MatrixStack p_230443_1_, int p_230443_2_, int p_230443_3_) {
         ...
         BeaconScreen.this.func_238652_a_(p_230443_1_, iformattabletextcomponent, p_230443_2_, p_230443_3_);
      }
