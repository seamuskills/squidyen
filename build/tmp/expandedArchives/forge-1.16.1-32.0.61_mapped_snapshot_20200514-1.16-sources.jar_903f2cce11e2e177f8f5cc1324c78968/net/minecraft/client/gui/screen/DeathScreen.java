...
public class DeathScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_230704_d_, this.field_230708_k_ / 2 / 2, 30, 16777215);
      RenderSystem.popMatrix();
      if (this.causeOfDeath != null) {
         this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.causeOfDeath, this.field_230708_k_ / 2, 85, 16777215);
      }

      this.func_238471_a_(p_230430_1_, this.field_230712_o_, I18n.format("deathScreen.score") + ": " + TextFormatting.YELLOW + this.field_230706_i_.player.getScore(), this.field_230708_k_ / 2, 100, 16777215);
