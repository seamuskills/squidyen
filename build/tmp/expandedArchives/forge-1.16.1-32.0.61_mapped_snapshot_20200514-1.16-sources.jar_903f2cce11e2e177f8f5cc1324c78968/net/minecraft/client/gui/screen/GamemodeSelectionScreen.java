   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      if (!this.func_238718_l_()) {
         ...
         this.field_238707_q_.ifPresent((p_238712_2_) -> {
            this.func_238472_a_(p_230430_1_, this.field_230712_o_, p_238712_2_.func_238725_a_(), this.field_230708_k_ / 2, this.field_230709_l_ / 2 - 30 - 20, -1);
         });
         this.func_238472_a_(p_230430_1_, this.field_230712_o_, field_238705_c_, this.field_230708_k_ / 2, this.field_230709_l_ / 2 + 5, 16777215);
