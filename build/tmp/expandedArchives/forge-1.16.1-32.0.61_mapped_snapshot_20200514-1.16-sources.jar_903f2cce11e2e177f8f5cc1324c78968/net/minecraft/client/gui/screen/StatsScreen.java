...
public class StatsScreen extends Screen implements IProgressMeter {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      if (this.doesGuiPauseGame) {
         ...
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, I18n.format("multiplayer.downloadingStats"), this.field_230708_k_ / 2, this.field_230709_l_ / 2, 16777215);
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, LOADING_STRINGS[(int)(Util.milliTime() / 150L % (long)LOADING_STRINGS.length)], this.field_230708_k_ / 2, this.field_230709_l_ / 2 + 9 * 2, 16777215);
      } else {
   ...
   class CustomStatsList extends ExtendedList<StatsScreen.CustomStatsList.Entry> {
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.CustomStatsList.Entry> {
         ...
         public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ITextComponent itextcomponent = (new TranslationTextComponent(StatsScreen.func_238672_b_(this.field_214405_b))).func_240699_a_(TextFormatting.GRAY);
            CustomStatsList.this.func_238476_c_(p_230432_1_, StatsScreen.this.field_230712_o_, itextcomponent.getString(), p_230432_4_ + 2, p_230432_3_ + 1, p_230432_2_ % 2 == 0 ? 16777215 : 9474192);
            String s = this.field_214405_b.format(StatsScreen.this.stats.getValue(this.field_214405_b));
            CustomStatsList.this.func_238476_c_(p_230432_1_, StatsScreen.this.field_230712_o_, s, p_230432_4_ + 2 + 213 - StatsScreen.this.field_230712_o_.getStringWidth(s), p_230432_3_ + 1, p_230432_2_ % 2 == 0 ? 16777215 : 9474192);
         }
      }
   }
   ...
   class MobStatsList extends ExtendedList<StatsScreen.MobStatsList.Entry> {
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.MobStatsList.Entry> {
         ...
         public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            MobStatsList.this.func_238476_c_(p_230432_1_, StatsScreen.this.field_230712_o_, s, p_230432_4_ + 2, p_230432_3_ + 1, 16777215);
            MobStatsList.this.func_238476_c_(p_230432_1_, StatsScreen.this.field_230712_o_, this.func_214409_a(s, i), p_230432_4_ + 2 + 10, p_230432_3_ + 1 + 9, i == 0 ? 6316128 : 9474192);
            MobStatsList.this.func_238476_c_(p_230432_1_, StatsScreen.this.field_230712_o_, this.func_214408_b(s, j), p_230432_4_ + 2 + 10, p_230432_3_ + 1 + 9 * 2, j == 0 ? 6316128 : 9474192);
         }
   ...
   class StatsList extends ExtendedList<StatsScreen.StatsList.Entry> {
      ...
      protected void func_238680_a_(MatrixStack p_238680_1_, @Nullable ITextComponent p_238680_2_, int p_238680_3_, int p_238680_4_) {
         if (p_238680_2_ != null) {
            ...
            StatsScreen.this.field_230712_o_.func_238407_a_(p_238680_1_, p_238680_2_, (float)i, (float)j, -1);
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.StatsList.Entry> {
         ...
         protected void func_238681_a_(MatrixStack p_238681_1_, @Nullable Stat<?> p_238681_2_, int p_238681_3_, int p_238681_4_, boolean p_238681_5_) {
            ...
            StatsList.this.func_238476_c_(p_238681_1_, StatsScreen.this.field_230712_o_, s, p_238681_3_ - StatsScreen.this.field_230712_o_.getStringWidth(s), p_238681_4_ + 5, p_238681_5_ ? 16777215 : 9474192);
         }
      }
   }
}
