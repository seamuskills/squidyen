         ...
         try {
            ...
            if (this.poem) {
               ...
               while((s = bufferedreader.readLine()) != null) {
                  ...
                  this.lines.addAll(this.field_230706_i_.fontRenderer.func_238420_b_().func_238365_g_(s, 274, Style.field_240709_b_));
            ...
            while((s3 = bufferedreader1.readLine()) != null) {
               ...
               for(ITextProperties itextproperties : this.field_230706_i_.fontRenderer.func_238420_b_().func_238365_g_(s3, 274, Style.field_240709_b_)) {
                  if (flag) {
      ...
      for(int i1 = 0; i1 < this.lines.size(); ++i1) {
         ...
         if ((float)l + f + 12.0F + 8.0F > 0.0F && (float)l + f < (float)this.field_230709_l_) {
            ...
            if (this.field_238664_v_.contains(i1)) {
               this.field_230712_o_.func_238407_a_(p_230430_1_, itextproperties, (float)(j + (274 - this.field_230712_o_.func_238414_a_(itextproperties)) / 2), (float)l, 16777215);
            } else {
               this.field_230712_o_.random.setSeed((long)((float)((long)i1 * 4238972211L) + this.time / 4.0F));
               this.field_230712_o_.func_238407_a_(p_230430_1_, itextproperties, (float)j, (float)l, 16777215);
            }
         }
