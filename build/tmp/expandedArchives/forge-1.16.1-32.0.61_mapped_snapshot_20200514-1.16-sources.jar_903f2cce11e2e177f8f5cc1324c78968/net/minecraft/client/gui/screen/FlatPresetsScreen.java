...
public class FlatPresetsScreen extends Screen {
   ...
   protected void func_231160_c_() {
      ...
      this.btnSelect = this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 155, this.field_230709_l_ - 28, 150, 20, new TranslationTextComponent("createWorld.customize.presets.select"), (p_213076_1_) -> {
      ...
      this.func_230480_a_(new Button(this.field_230708_k_ / 2 + 5, this.field_230709_l_ - 28, 150, 20, DialogTexts.field_240633_d_, (p_238634_1_) -> {
         this.field_230706_i_.displayGuiScreen(this.parentScreen);
      }));
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238475_b_(p_230430_1_, this.field_230712_o_, this.presetsShare, 50, 30, 10526880);
      this.func_238475_b_(p_230430_1_, this.field_230712_o_, this.listText, 50, 70, 10526880);
   ...
   class SlotList extends ExtendedList<FlatPresetsScreen.SlotList.PresetEntry> {
      ...
      public class PresetEntry extends ExtendedList.AbstractListEntry<FlatPresetsScreen.SlotList.PresetEntry> {
         public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            FlatPresetsScreen.this.field_230712_o_.func_238422_b_(p_230432_1_, flatpresetsscreen$layeritem.name, (float)(p_230432_4_ + 18 + 5), (float)(p_230432_3_ + 6), 16777215);
         }
