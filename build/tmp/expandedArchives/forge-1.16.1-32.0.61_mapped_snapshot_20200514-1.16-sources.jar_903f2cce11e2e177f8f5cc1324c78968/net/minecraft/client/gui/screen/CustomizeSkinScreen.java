...
public class CustomizeSkinScreen extends SettingsScreen {
   ...
   private ITextComponent func_238655_a_(PlayerModelPart p_238655_1_) {
      return p_238655_1_.getName().func_230532_e_().func_240702_b_(": ").func_230529_a_(DialogTexts.func_240638_a_(this.gameSettings.getModelParts().contains(p_238655_1_)));
   }
}
