...
public class AdvancementsScreen extends Screen implements ClientAdvancementManager.IListener {
   ...
   private void func_238696_c_(MatrixStack p_238696_1_, int p_238696_2_, int p_238696_3_, int p_238696_4_, int p_238696_5_) {
      ...
      if (advancementtabgui == null) {
         ...
         this.field_230712_o_.func_238421_b_(p_238696_1_, s, (float)(p_238696_4_ + 9 + 117 - i / 2), (float)(p_238696_5_ + 18 + 56 - 9 / 2), -1);
         this.field_230712_o_.func_238421_b_(p_238696_1_, ":(", (float)(p_238696_4_ + 9 + 117 - this.field_230712_o_.getStringWidth(":(") / 2), (float)(p_238696_5_ + 18 + 113 - 9), -1);
      } else {
   ...
   public void func_238695_a_(MatrixStack p_238695_1_, int p_238695_2_, int p_238695_3_) {
      ...
      this.field_230712_o_.func_238421_b_(p_238695_1_, I18n.format("gui.advancements"), (float)(p_238695_2_ + 8), (float)(p_238695_3_ + 6), 4210752);
   }
