...
public class CheckboxButton extends AbstractButton {
   ...
   public void func_230431_b_(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
      ...
      if (this.field_238499_c_) {
         this.func_238475_b_(p_230431_1_, fontrenderer, this.func_230458_i_(), this.field_230690_l_ + 24, this.field_230691_m_ + (this.field_230689_k_ - 8) / 2, 14737632 | MathHelper.ceil(this.field_230695_q_ * 255.0F) << 24);
      }
