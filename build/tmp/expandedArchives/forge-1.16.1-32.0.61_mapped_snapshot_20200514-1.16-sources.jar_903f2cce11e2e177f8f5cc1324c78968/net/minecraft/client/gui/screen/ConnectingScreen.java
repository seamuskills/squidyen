...
public class ConnectingScreen extends Screen {
         ...
         public void run() {
            ...
            try {
               ...
               ConnectingScreen.this.field_230706_i_.execute(() -> {
                  ConnectingScreen.this.field_230706_i_.displayGuiScreen(new DisconnectedScreen(ConnectingScreen.this.previousGuiScreen, "connect.failed", new TranslationTextComponent("disconnect.genericReason", "Unknown host")));
               });
               ...
               ConnectingScreen.this.field_230706_i_.execute(() -> {
                  ConnectingScreen.this.field_230706_i_.displayGuiScreen(new DisconnectedScreen(ConnectingScreen.this.previousGuiScreen, "connect.failed", new TranslationTextComponent("disconnect.genericReason", s)));
               });
            }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_209515_s, this.field_230708_k_ / 2, this.field_230709_l_ / 2 - 50, 16777215);
