...
public class CreateFlatWorldScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238475_b_(p_230430_1_, this.field_230712_o_, this.materialText, i, 32, 16777215);
      this.func_238475_b_(p_230430_1_, this.field_230712_o_, this.heightText, i + 2 + 213 - this.field_230712_o_.func_238414_a_(this.heightText), 32, 16777215);
   ...
   class DetailsList extends ExtendedList<CreateFlatWorldScreen.DetailsList.LayerEntry> {
      ...
      class LayerEntry extends ExtendedList.AbstractListEntry<CreateFlatWorldScreen.DetailsList.LayerEntry> {
         ...
         public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            CreateFlatWorldScreen.this.field_230712_o_.func_238422_b_(p_230432_1_, item.getDisplayName(itemstack), (float)(p_230432_4_ + 18 + 5), (float)(p_230432_3_ + 3), 16777215);
            String s;
            if (p_230432_2_ == 0) {
