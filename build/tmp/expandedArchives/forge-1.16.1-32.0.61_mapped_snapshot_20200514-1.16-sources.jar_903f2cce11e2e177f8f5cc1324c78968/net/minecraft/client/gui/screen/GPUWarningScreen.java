...
public class GPUWarningScreen extends Screen {
   ...
   public void func_231158_b_(Minecraft p_231158_1_, int p_231158_2_, int p_231158_3_) {
      ...
      this.field_241587_c_ = this.field_230712_o_.func_238425_b_(this.field_241585_a_, i1);
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_230704_d_, this.field_230708_k_ / 2, this.field_241588_p_ - 9 * 2, -1);
      int i = this.field_241588_p_;

      for(ITextProperties itextproperties : this.field_241587_c_) {
         this.func_238472_a_(p_230430_1_, this.field_230712_o_, itextproperties, this.field_230708_k_ / 2, i, -1);
         i += 9;
      }
