...
public class MultiplayerWarningScreen extends Screen {
   ...
   protected void func_231160_c_() {
      ...
      this.field_230163_h_.addAll(this.field_230712_o_.func_238425_b_(field_230158_c_, this.field_230708_k_ - 50));
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, field_230157_b_, this.field_230708_k_ / 2, 30, 16777215);
      int i = 70;
