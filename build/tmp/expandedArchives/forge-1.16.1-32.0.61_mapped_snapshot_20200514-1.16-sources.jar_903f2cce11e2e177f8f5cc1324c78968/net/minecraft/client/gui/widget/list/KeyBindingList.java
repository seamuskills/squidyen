...
public class KeyBindingList extends AbstractOptionList<KeyBindingList.Entry> {
   ...
   public class CategoryEntry extends KeyBindingList.Entry {
      ...
      public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         KeyBindingList.this.field_230668_b_.fontRenderer.func_238422_b_(p_230432_1_, this.labelText, (float)(KeyBindingList.this.field_230668_b_.currentScreen.field_230708_k_ / 2 - this.labelWidth / 2), (float)(p_230432_3_ + p_230432_6_ - 9 - 1), 16777215);
      }
   ...
   public class KeyEntry extends KeyBindingList.Entry {
      ...
      public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         ...
         KeyBindingList.this.field_230668_b_.fontRenderer.func_238422_b_(p_230432_1_, this.keyDesc, (float)(p_230432_4_ + 90 - KeyBindingList.this.maxListLabelWidth), (float)(p_230432_3_ + p_230432_6_ / 2 - 9 / 2), 16777215);
