   ...
   class CharacterRenderer implements TextProcessing.ICharacterConsumer {
      ...
      public boolean onChar(int p_onChar_1_, Style p_onChar_2_, int p_onChar_3_) {
         ...
         if (!(texturedglyph instanceof EmptyGlyph)) {
            ...
            FontRenderer.this.drawGlyph(texturedglyph, flag, p_onChar_2_.getItalic(), f5, this.field_238438_l_ + f4, this.field_238439_m_ + f4, this.field_238435_i_, ivertexbuilder, f, f1, f2, f3, this.field_238437_k_);
         }
