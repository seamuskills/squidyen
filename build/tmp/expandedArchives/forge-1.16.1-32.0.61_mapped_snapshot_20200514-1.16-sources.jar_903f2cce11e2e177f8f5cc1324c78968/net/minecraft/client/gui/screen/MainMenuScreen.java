...
public class MainMenuScreen extends Screen {
   ...
   private void addDemoButtons(int yIn, int rowHeightIn) {
      this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 100, yIn, 200, 20, new TranslationTextComponent("menu.playdemo"), (p_213091_1_) -> {
         this.field_230706_i_.func_238192_a_("Demo_World", MinecraftServer.DEMO_WORLD_SETTINGS, IDynamicRegistries.func_239770_b_(), DimensionGeneratorSettings.field_236202_b_);
      }));
      this.buttonResetDemo = this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 100, yIn + rowHeightIn * 1, 200, 20, new TranslationTextComponent("menu.resetdemo"), (p_238658_1_) -> {
         ...
         try (SaveFormat.LevelSave saveformat$levelsave1 = saveformat.func_237274_c_("Demo_World")) {
            ...
            if (worldsummary1 != null) {
               this.field_230706_i_.displayGuiScreen(new ConfirmScreen(this::deleteDemoWorld, new TranslationTextComponent("selectWorld.deleteQuestion"), new TranslationTextComponent("selectWorld.deleteWarning", worldsummary1.getDisplayName()), new TranslationTextComponent("selectWorld.deleteButton"), DialogTexts.field_240633_d_));
            }
      ...
      try (SaveFormat.LevelSave saveformat$levelsave = this.field_230706_i_.getSaveLoader().func_237274_c_("Demo_World")) {
         ...
         if (worldsummary == null) {
            this.buttonResetDemo.field_230693_o_ = false;
         }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if ((l & -67108864) != 0) {
         ...
         if (this.splashText != null) {
            ...
            this.func_238471_a_(p_230430_1_, this.field_230712_o_, this.splashText, 0, -8, 16776960 | l);
         ...
         net.minecraftforge.fml.BrandingControl.forEachLine(true, true, (brdline, brd) ->
               this.func_238476_c_(p_230430_1_, this.field_230712_o_, brd, 2, this.field_230709_l_ - ( 10 + brdline * (this.field_230712_o_.FONT_HEIGHT + 1)), 16777215 | l)
         );

         net.minecraftforge.fml.BrandingControl.forEachAboveCopyrightLine((brdline, brd) ->
               this.func_238476_c_(p_230430_1_, this.field_230712_o_, brd, this.field_230708_k_ - field_230712_o_.getStringWidth(brd), this.field_230709_l_ - (10 + (brdline + 1) * ( this.field_230712_o_.FONT_HEIGHT + 1)), 16777215 | l)
         );
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, "Copyright Mojang AB. Do not distribute!", this.widthCopyrightRest, this.field_230709_l_ - 10, 16777215 | l);
