...
public class ReadBookScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (this.cachedPage != this.currPage) {
         ...
         this.cachedPageLines = this.field_230712_o_.func_238420_b_().func_238362_b_(itextproperties, 114, Style.field_240709_b_);
      }

      this.cachedPage = this.currPage;
      int i1 = this.func_214156_a(s);
      this.field_230712_o_.func_238421_b_(p_230430_1_, s, (float)(i - i1 + 192 - 44), 18.0F, 0);
      int k = Math.min(128 / 9, this.cachedPageLines.size());

      for(int l = 0; l < k; ++l) {
         ITextProperties itextproperties1 = this.cachedPageLines.get(l);
         this.field_230712_o_.func_238422_b_(p_230430_1_, itextproperties1, (float)(i + 36), (float)(32 + l * 9), 0);
      }
   ...
   private int func_214156_a(String p_214156_1_) {
      return this.field_230712_o_.getStringWidth(this.field_230712_o_.getBidiFlag() ? this.field_230712_o_.bidiReorder(p_214156_1_) : p_214156_1_);
   }
         ...
         if (i >= 0 && j >= 0) {
            ...
            if (i <= 114 && j < 9 * k + k) {
               ...
               if (l >= 0 && l < this.cachedPageLines.size()) {
                  ...
                  return this.field_230706_i_.fontRenderer.func_238420_b_().func_238357_a_(itextproperties, i);
               } else {
                  return null;
               }
            } else {
