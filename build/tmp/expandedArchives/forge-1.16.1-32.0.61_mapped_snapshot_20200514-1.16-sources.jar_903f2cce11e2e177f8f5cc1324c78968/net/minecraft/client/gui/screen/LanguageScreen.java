...
public class LanguageScreen extends SettingsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_230704_d_, this.field_230708_k_ / 2, 16, 16777215);
      this.func_238471_a_(p_230430_1_, this.field_230712_o_, "(" + I18n.format("options.languageWarning") + ")", this.field_230708_k_ / 2, this.field_230709_l_ - 56, 8421504);
