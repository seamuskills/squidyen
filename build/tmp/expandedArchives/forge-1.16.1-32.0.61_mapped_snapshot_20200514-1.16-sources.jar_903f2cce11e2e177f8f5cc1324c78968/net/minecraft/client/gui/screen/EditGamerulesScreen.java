...
public class EditGamerulesScreen extends Screen {
   ...
   public class BooleanEntry extends EditGamerulesScreen.ValueEntry {
      ...
      public BooleanEntry(final ITextComponent p_i232311_2_, List<ITextProperties> p_i232311_3_, final String p_i232311_4_, final GameRules.BooleanValue p_i232311_5_) {
         ...
         this.field_238986_c_ = new Button(10, 5, 44, 20, DialogTexts.func_240638_a_(p_i232311_5_.get()), (p_238988_1_) -> {
            ...
            protected IFormattableTextComponent func_230442_c_() {
               return BooleanEntry.this.func_238989_a_(p_i232311_2_, p_i232311_5_.get()).func_230532_e_().func_240702_b_("\n").func_240702_b_(p_i232311_4_);
            }
         };
      ...
      private IFormattableTextComponent func_238989_a_(ITextComponent p_238989_1_, boolean p_238989_2_) {
         return (new StringTextComponent("")).func_230529_a_(p_238989_1_).func_240702_b_(": ").func_230529_a_(DialogTexts.func_240638_a_(p_238989_2_));
      }
   ...
   public class NameEntry extends EditGamerulesScreen.Gamerule {
      ...
      public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         EditGamerulesScreen.this.func_238472_a_(p_230432_1_, EditGamerulesScreen.this.field_230706_i_.fontRenderer, this.field_238994_c_, p_230432_4_ + p_230432_5_ / 2, p_230432_3_ + 5, 16777215);
      }
