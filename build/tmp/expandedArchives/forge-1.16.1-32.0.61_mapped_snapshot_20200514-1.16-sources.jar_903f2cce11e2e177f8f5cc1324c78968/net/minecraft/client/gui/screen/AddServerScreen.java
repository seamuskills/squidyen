...
public class AddServerScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_230704_d_, this.field_230708_k_ / 2, 17, 16777215);
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("addServer.enterName"), this.field_230708_k_ / 2 - 100, 53, 10526880);
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("addServer.enterIp"), this.field_230708_k_ / 2 - 100, 94, 10526880);
