...
public class AdvancementEntryGui extends AbstractGui {
   ...
   public AdvancementEntryGui(AdvancementTabGui p_i47385_1_, Minecraft p_i47385_2_, Advancement p_i47385_3_, DisplayInfo p_i47385_4_) {
      ...
      this.title = p_i47385_2_.fontRenderer.func_238417_a_(p_i47385_4_.getTitle(), 163);
      ...
      int l = 29 + p_i47385_2_.fontRenderer.func_238414_a_(this.title) + k;
      this.description = this.func_238694_a_(TextComponentUtils.func_240648_a_(p_i47385_4_.getDescription().func_230532_e_(), Style.field_240709_b_.func_240712_a_(p_i47385_4_.getFrame().getFormat())), l);

      for(ITextProperties itextproperties : this.description) {
         l = Math.max(l, p_i47385_2_.fontRenderer.func_238414_a_(itextproperties));
      }
