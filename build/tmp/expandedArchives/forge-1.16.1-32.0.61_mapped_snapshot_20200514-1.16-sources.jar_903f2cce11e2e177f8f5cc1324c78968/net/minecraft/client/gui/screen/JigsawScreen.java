...
public class JigsawScreen extends Screen {
   ...
   protected void func_231160_c_() {
      ...
      int i = this.field_230712_o_.getStringWidth(I18n.format("jigsaw_block.joint_label")) + 10;
      ...
      this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 50, 180, 100, 20, new TranslationTextComponent("jigsaw_block.keep_jigsaws"), (p_238832_1_) -> {
         ...
         public ITextComponent func_230458_i_() {
            return super.func_230458_i_().func_230532_e_().func_240702_b_(" ").func_230529_a_(DialogTexts.func_240638_a_(JigsawScreen.this.field_238822_s_));
         }
      });
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("jigsaw_block.pool"), this.field_230708_k_ / 2 - 153, 10, 10526880);
      this.field_238820_p_.func_230430_a_(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("jigsaw_block.name"), this.field_230708_k_ / 2 - 153, 45, 10526880);
      this.field_238818_b_.func_230430_a_(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("jigsaw_block.target"), this.field_230708_k_ / 2 - 153, 80, 10526880);
      this.field_238819_c_.func_230430_a_(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("jigsaw_block.final_state"), this.field_230708_k_ / 2 - 153, 115, 10526880);
      ...
      if (JigsawBlock.func_235508_h_(this.field_214259_a.getBlockState()).getAxis().isVertical()) {
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("jigsaw_block.joint_label"), this.field_230708_k_ / 2 - 153, 156, 16777215);
      }
