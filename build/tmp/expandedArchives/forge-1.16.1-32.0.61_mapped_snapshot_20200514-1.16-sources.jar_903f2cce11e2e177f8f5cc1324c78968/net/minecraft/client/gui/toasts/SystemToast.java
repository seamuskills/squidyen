...
public class SystemToast implements IToast {
   ...
   private List<ITextProperties> field_238531_e_;
   ...
   public static SystemToast func_238534_a_(Minecraft p_238534_0_, SystemToast.Type p_238534_1_, ITextComponent p_238534_2_, ITextComponent p_238534_3_) {
      ...
      List<ITextProperties> list = fontrenderer.func_238420_b_().func_238362_b_(p_238534_3_, 200, Style.field_240709_b_);
      int i = Math.max(200, list.stream().mapToInt(fontrenderer::func_238414_a_).max().orElse(200));
      return new SystemToast(p_238534_1_, p_238534_2_, list, i + 30);
   }

   private SystemToast(SystemToast.Type p_i232264_1_, ITextComponent p_i232264_2_, List<ITextProperties> p_i232264_3_, int p_i232264_4_) {
   ...
   private static ImmutableList<ITextProperties> func_238537_a_(@Nullable ITextComponent p_238537_0_) {
      return p_238537_0_ == null ? ImmutableList.of() : ImmutableList.of(p_238537_0_);
   }
   ...
   public IToast.Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_) {
      ...
      if (this.field_238531_e_ == null) {
         p_230444_2_.getMinecraft().fontRenderer.func_238422_b_(p_230444_1_, this.title, 18.0F, 12.0F, -256);
      } else {
         p_230444_2_.getMinecraft().fontRenderer.func_238422_b_(p_230444_1_, this.title, 18.0F, 7.0F, -256);
