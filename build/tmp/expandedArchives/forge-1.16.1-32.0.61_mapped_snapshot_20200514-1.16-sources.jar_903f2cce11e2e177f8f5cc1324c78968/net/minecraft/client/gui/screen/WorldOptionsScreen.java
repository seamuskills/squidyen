...
public class WorldOptionsScreen implements IScreen, IRenderable {
   ...
   public void func_239048_a_(final CreateWorldScreen p_239048_1_, Minecraft p_239048_2_, FontRenderer p_239048_3_) {
      ...
      this.field_239027_a_ = p_239048_1_.func_230480_a_(new Button(i, 151, 150, 20, new TranslationTextComponent("selectWorld.bonusItems"), (p_239047_1_) -> {
         ...
         public ITextComponent func_230458_i_() {
            return super.func_230458_i_().func_230532_e_().func_240702_b_(" ").func_230529_a_(DialogTexts.func_240638_a_(WorldOptionsScreen.this.field_239039_m_.func_236223_d_() && !p_239048_1_.hardCoreMode));
         }
      });
      ...
      this.field_239037_k_ = p_239048_1_.func_230480_a_(new Button(i, 185, 150, 20, new TranslationTextComponent("selectWorld.import_worldgen_settings"), (p_239049_3_) -> {
         ...
         if (s != null) {
            ...
            ResourcePackList<ResourcePackInfo> resourcepacklist = new ResourcePackList<>(ResourcePackInfo::new, new ServerPackFinder(), new FolderPackFinder(p_239048_1_.func_238957_j_().toFile(), IPackNameDecorator.field_232627_c_));
            ...
            WorldSettingsImport<JsonElement> worldsettingsimport = WorldSettingsImport.func_240876_a_(JsonOps.INSTANCE, datapackregistries.func_240970_h_(), idynamicregistries$impl);
