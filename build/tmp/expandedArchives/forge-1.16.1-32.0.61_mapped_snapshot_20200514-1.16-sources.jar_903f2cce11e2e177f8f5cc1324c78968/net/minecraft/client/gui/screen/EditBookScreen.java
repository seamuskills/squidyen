...
public class EditBookScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (this.bookGettingSigned) {
         ...
         this.field_230712_o_.func_238421_b_(p_230430_1_, s1, (float)(i + 36 + (114 - k) / 2), 34.0F, 0);
         int l = this.getTextWidth(s);
         this.field_230712_o_.func_238421_b_(p_230430_1_, s, (float)(i + 36 + (114 - l) / 2), 50.0F, 0);
         String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName().getString());
         int i1 = this.getTextWidth(s2);
         this.field_230712_o_.func_238421_b_(p_230430_1_, TextFormatting.DARK_GRAY + s2, (float)(i + 36 + (114 - i1) / 2), 60.0F, 0);
         this.field_230712_o_.func_238418_a_(new TranslationTextComponent("book.finalizeWarning"), i + 36, 82, 114, 0);
      } else {
         String s3 = I18n.format("book.pageIndicator", this.currPage + 1, this.getPageCount());
         int j1 = this.getTextWidth(s3);
         this.field_230712_o_.func_238421_b_(p_230430_1_, s3, (float)(i - j1 + 192 - 44), 18.0F, 0);
         EditBookScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();

         for(EditBookScreen.BookLine editbookscreen$bookline : editbookscreen$bookpage.field_238784_f_) {
            this.field_230712_o_.func_238422_b_(p_230430_1_, editbookscreen$bookline.field_238797_c_, (float)editbookscreen$bookline.field_238798_d_, (float)editbookscreen$bookline.field_238799_e_, -16777216);
         }
   ...
   private int getTextWidth(String text) {
      return this.field_230712_o_.getStringWidth(this.field_230712_o_.getBidiFlag() ? this.field_230712_o_.bidiReorder(text) : text);
   }
