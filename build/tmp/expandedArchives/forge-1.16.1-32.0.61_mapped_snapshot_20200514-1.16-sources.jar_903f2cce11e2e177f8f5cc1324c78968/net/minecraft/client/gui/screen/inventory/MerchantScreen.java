...
public class MerchantScreen extends ContainerScreen<MerchantContainer> {
   ...
   protected void func_230451_b_(MatrixStack p_230451_1_, int p_230451_2_, int p_230451_3_) {
      ...
      if (i > 0 && i <= 5 && this.container.func_217042_i()) {
         ...
         int j = this.field_230712_o_.func_238414_a_(this.field_230704_d_);
         int k = this.field_230712_o_.getStringWidth(s);
         int l = j + k + 3;
         int i1 = 49 + this.xSize / 2 - l / 2;
         this.field_230712_o_.func_238422_b_(p_230451_1_, this.field_230704_d_, (float)i1, 6.0F, 4210752);
         this.field_230712_o_.func_238421_b_(p_230451_1_, s, (float)(i1 + j + 3), 6.0F, 4210752);
      } else {
         this.field_230712_o_.func_238422_b_(p_230451_1_, this.field_230704_d_, (float)(49 + this.xSize / 2 - this.field_230712_o_.func_238414_a_(this.field_230704_d_) / 2), 6.0F, 4210752);
      }
      ...
      int j1 = this.field_230712_o_.getStringWidth(s1);
      this.field_230712_o_.func_238421_b_(p_230451_1_, s1, (float)(5 - j1 / 2 + 48), 6.0F, 4210752);
   }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         if (merchantoffer1.hasNoUsesLeft() && this.isPointInRegion(186, 35, 22, 21, (double)p_230430_2_, (double)p_230430_3_) && this.container.func_223432_h()) {
            this.func_238652_a_(p_230430_1_, new TranslationTextComponent("merchant.deprecated"), p_230430_2_, p_230430_3_);
         }
