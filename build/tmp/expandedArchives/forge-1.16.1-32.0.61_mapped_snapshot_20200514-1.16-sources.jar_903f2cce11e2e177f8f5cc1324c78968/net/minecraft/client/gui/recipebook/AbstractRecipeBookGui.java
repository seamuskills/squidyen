...
public abstract class AbstractRecipeBookGui extends RecipeBookGui {
   ...
   protected ITextComponent func_230478_f_() {
      return (ITextComponent)(this.toggleRecipesBtn.isStateTriggered() ? this.func_230479_g_() : new TranslationTextComponent("gui.recipebook.toggleRecipes.all"));
   }

   protected abstract ITextComponent func_230479_g_();
