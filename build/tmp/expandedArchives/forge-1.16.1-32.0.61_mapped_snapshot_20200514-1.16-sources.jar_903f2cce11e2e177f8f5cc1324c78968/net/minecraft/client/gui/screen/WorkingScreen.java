   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      if (this.doneWorking) {
         ...
         if (this.field_238648_a_ != null) {
            this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_238648_a_, this.field_230708_k_ / 2, 70, 16777215);
         }

         if (this.stage != null && this.progress != 0) {
            this.func_238472_a_(p_230430_1_, this.field_230712_o_, (new StringTextComponent("")).func_230529_a_(this.stage).func_240702_b_(" " + this.progress + "%"), this.field_230708_k_ / 2, 90, 16777215);
         }
