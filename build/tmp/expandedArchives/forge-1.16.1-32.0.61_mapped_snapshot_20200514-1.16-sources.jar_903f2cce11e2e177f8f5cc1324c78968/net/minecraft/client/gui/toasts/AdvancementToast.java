...
public class AdvancementToast implements IToast {
   ...
   public IToast.Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_) {
      ...
      if (displayinfo != null) {
         List<ITextProperties> list = p_230444_2_.getMinecraft().fontRenderer.func_238425_b_(displayinfo.getTitle(), 125);
         int i = displayinfo.getFrame() == FrameType.CHALLENGE ? 16746751 : 16776960;
         if (list.size() == 1) {
            p_230444_2_.getMinecraft().fontRenderer.func_238421_b_(p_230444_1_, I18n.format("advancements.toast." + displayinfo.getFrame().getName()), 30.0F, 7.0F, i | -16777216);
            ...
            if (p_230444_3_ < 1500L) {
               ...
               p_230444_2_.getMinecraft().fontRenderer.func_238421_b_(p_230444_1_, I18n.format("advancements.toast." + displayinfo.getFrame().getName()), 30.0F, 11.0F, i | k);
            } else {
               ...
               for(ITextProperties itextproperties : list) {
                  p_230444_2_.getMinecraft().fontRenderer.func_238422_b_(p_230444_1_, itextproperties, 30.0F, (float)l, 16777215 | i1);
                  l += 9;
               }
            }
         }
