...
public class ErrorScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_230704_d_, this.field_230708_k_ / 2, 90, 16777215);
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.message, this.field_230708_k_ / 2, 110, 16777215);
