...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238471_a_(p_230430_1_, this.field_230712_o_, I18n.format("advMode.setCommand"), this.field_230708_k_ / 2, 20, 16777215);
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("advMode.command"), this.field_230708_k_ / 2 - 150, 40, 10526880);
      ...
      if (!this.resultTextField.getText().isEmpty()) {
         ...
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("advMode.previousOutput"), this.field_230708_k_ / 2 - 150, i + 4, 10526880);
