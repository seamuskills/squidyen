...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry> {
   ...
   public static class LanDetectedEntry extends ServerSelectionList.Entry {
      ...
      public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         this.mc.fontRenderer.func_238421_b_(p_230432_1_, I18n.format("lanServer.title"), (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 1), 16777215);
         ...
         if (this.mc.gameSettings.hideServerAddress) {
            this.mc.fontRenderer.func_238421_b_(p_230432_1_, I18n.format("selectServer.hiddenAddress"), (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 12 + 11), 3158064);
         } else {
   ...
   public static class LanScanEntry extends ServerSelectionList.Entry {
      ...
      public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         ...
         this.mc.fontRenderer.func_238421_b_(p_230432_1_, I18n.format("lanServer.scanning"), (float)(this.mc.currentScreen.field_230708_k_ / 2 - this.mc.fontRenderer.getStringWidth(I18n.format("lanServer.scanning")) / 2), (float)i, 16777215);
         String s;
         ...
         if (!this.server.pinged) {
            ...
            ServerSelectionList.field_214358_b.submit(() -> {
               try {
                  ...
                  this.server.serverMOTD = (new TranslationTextComponent("multiplayer.status.cannot_resolve")).func_240699_a_(TextFormatting.DARK_RED);
               } catch (Exception exception) {
                  this.server.pingToServer = -1L;
                  this.server.serverMOTD = (new TranslationTextComponent("multiplayer.status.cannot_connect")).func_240699_a_(TextFormatting.DARK_RED);
               }
