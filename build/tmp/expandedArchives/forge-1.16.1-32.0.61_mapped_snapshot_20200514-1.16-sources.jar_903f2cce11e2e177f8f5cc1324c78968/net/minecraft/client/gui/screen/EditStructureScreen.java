...
public class EditStructureScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_230704_d_, this.field_230708_k_ / 2, 10, 16777215);
      if (structuremode != StructureMode.DATA) {
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("structure_block.structure_name"), this.field_230708_k_ / 2 - 153, 30, 10526880);
      ...
      if (structuremode == StructureMode.LOAD || structuremode == StructureMode.SAVE) {
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("structure_block.position"), this.field_230708_k_ / 2 - 153, 70, 10526880);
         ...
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, s, this.field_230708_k_ / 2 + 154 - i, 150, 10526880);
      }

      if (structuremode == StructureMode.SAVE) {
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("structure_block.size"), this.field_230708_k_ / 2 - 153, 110, 10526880);
         ...
         int k = this.field_230712_o_.getStringWidth(s2);
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, s2, this.field_230708_k_ / 2 + 154 - k, 110, 10526880);
         String s1 = I18n.format("structure_block.show_air");
         int j = this.field_230712_o_.getStringWidth(s1);
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, s1, this.field_230708_k_ / 2 + 154 - j, 70, 10526880);
      }

      if (structuremode == StructureMode.LOAD) {
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("structure_block.integrity"), this.field_230708_k_ / 2 - 153, 110, 10526880);
         ...
         int l = this.field_230712_o_.getStringWidth(s3);
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, s3, this.field_230708_k_ / 2 + 154 - l, 70, 10526880);
      }

      if (structuremode == StructureMode.DATA) {
         this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format("structure_block.custom_data"), this.field_230708_k_ / 2 - 153, 110, 10526880);
         this.dataEdit.func_230430_a_(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      }

      String s4 = "structure_block.mode_info." + structuremode.func_176610_l();
      this.func_238476_c_(p_230430_1_, this.field_230712_o_, I18n.format(s4), this.field_230708_k_ / 2 - 153, 174, 10526880);
