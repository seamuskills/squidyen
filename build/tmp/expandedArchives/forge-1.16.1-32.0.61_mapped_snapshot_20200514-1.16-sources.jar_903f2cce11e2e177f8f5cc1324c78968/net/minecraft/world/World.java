   ...
   public boolean func_241211_a_(BlockPos p_241211_1_, BlockState p_241211_2_, int p_241211_3_, int p_241211_4_) {
      if (isOutsideBuildHeight(p_241211_1_)) {
         ...
         if (blockstate == null) {
            ...
            if (blockstate1 != blockstate && (blockstate1.getOpacity(this, p_241211_1_) != oldOpacity || blockstate1.getLightValue(this, p_241211_1_) != oldLight || blockstate1.isTransparent() || blockstate.isTransparent())) {
