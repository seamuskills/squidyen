...
public class Teleporter implements net.minecraftforge.common.util.ITeleporter {
   ...
   public boolean placeInPortal(Entity p_222268_1_, float p_222268_2_) {
      ...
      BlockPattern.PortalInfo blockpattern$portalinfo = this.placeInExistingPortal(p_222268_1_.func_233580_cy_(), p_222268_1_.getMotion(), direction, vector3d.x, vector3d.y, p_222268_1_ instanceof PlayerEntity);
