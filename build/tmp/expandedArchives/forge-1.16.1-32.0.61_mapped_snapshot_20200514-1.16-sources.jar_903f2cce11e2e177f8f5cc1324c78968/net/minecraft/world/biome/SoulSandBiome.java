...
public class SoulSandBiome extends Biome {
   protected SoulSandBiome() {
      super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.field_237190_ae_, SurfaceBuilder.field_237184_N_).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).func_235246_b_(4159204).func_235248_c_(329011).func_235239_a_(1787717).func_235244_a_(new ParticleEffectAmbience(ParticleTypes.field_239813_am_, 0.00625F)).func_235241_a_(SoundEvents.field_232798_l_).func_235243_a_(new MoodSoundAmbience(SoundEvents.field_232800_m_, 6000, 8, 2.0D)).func_235242_a_(new SoundAdditionsAmbience(SoundEvents.field_232785_k_, 0.0111D)).func_235240_a_(BackgroundMusicTracks.func_232677_a_(SoundEvents.field_232761_iq_)).func_235238_a_()).parent((String)null).func_235098_a_(ImmutableList.of(new Biome.Attributes(0.0F, -0.5F, 0.0F, 0.0F, 0.0F))));
      ...
      this.func_235059_a_(EntityType.field_233589_aE_, 0.7D, 0.15D);
   }
}
