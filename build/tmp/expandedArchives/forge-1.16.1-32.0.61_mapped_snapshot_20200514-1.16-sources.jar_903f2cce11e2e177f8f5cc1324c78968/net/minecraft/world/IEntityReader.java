...
public interface IEntityReader {
   ...
   default boolean checkNoEntityCollision(@Nullable Entity entityIn, VoxelShape shape) {
      if (shape.isEmpty()) {
         ...
         Iterator iterator = this.getEntitiesWithinAABBExcludingEntity(entityIn, shape.getBoundingBox()).iterator();
   ...
   default Stream<VoxelShape> func_230318_c_(@Nullable Entity p_230318_1_, AxisAlignedBB p_230318_2_, Predicate<Entity> p_230318_3_) {
      if (p_230318_2_.getAverageEdgeLength() < 1.0E-7D) {
         ...
         return this.getEntitiesInAABBexcluding(p_230318_1_, axisalignedbb, p_230318_3_.and((p_234892_1_) -> {
            return p_230318_1_ == null || !p_230318_1_.isRidingSameEntity(p_234892_1_);
         })).stream().flatMap((p_234891_2_) -> {
            if (p_230318_1_ != null) {
               AxisAlignedBB axisalignedbb1 = p_230318_1_.getCollisionBox(p_234891_2_);
               if (axisalignedbb1 != null && axisalignedbb1.intersects(axisalignedbb)) {
                  return Stream.of(p_234891_2_.getCollisionBoundingBox(), axisalignedbb1);
               }
            }

            return Stream.of(p_234891_2_.getCollisionBoundingBox());
         }).filter(Objects::nonNull).map(VoxelShapes::create);
      }
   }
