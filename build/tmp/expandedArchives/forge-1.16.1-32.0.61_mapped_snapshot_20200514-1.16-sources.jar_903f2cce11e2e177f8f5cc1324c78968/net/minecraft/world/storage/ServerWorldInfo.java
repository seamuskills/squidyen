...
public class ServerWorldInfo implements IServerWorldInfo, IServerConfiguration {
   ...
   private ServerWorldInfo(@Nullable DataFixer p_i232159_1_, int p_i232159_2_, @Nullable CompoundNBT p_i232159_3_, boolean p_i232159_4_, int p_i232159_5_, int p_i232159_6_, int p_i232159_7_, long p_i232159_8_, long p_i232159_10_, int p_i232159_12_, int p_i232159_13_, int p_i232159_14_, boolean p_i232159_15_, int p_i232159_16_, boolean p_i232159_17_, boolean p_i232159_18_, boolean p_i232159_19_, WorldBorder.Serializer p_i232159_20_, int p_i232159_21_, int p_i232159_22_, @Nullable UUID p_i232159_23_, LinkedHashSet<String> p_i232159_24_, TimerCallbackManager<MinecraftServer> p_i232159_25_, @Nullable CompoundNBT p_i232159_26_, CompoundNBT p_i232159_27_, WorldSettings p_i232159_28_, DimensionGeneratorSettings p_i232159_29_, Lifecycle p_i232159_30_) {
      this.field_237350_j_ = p_i232159_1_;
      this.field_237339_C_ = p_i232159_4_;
      this.field_237345_e_ = p_i232159_5_;
      this.field_237346_f_ = p_i232159_6_;
      this.field_237347_g_ = p_i232159_7_;
      this.field_237348_h_ = p_i232159_8_;
      this.field_237349_i_ = p_i232159_10_;
      this.field_237354_n_ = p_i232159_12_;
      this.field_237355_o_ = p_i232159_13_;
      this.field_237357_q_ = p_i232159_14_;
      this.field_237356_p_ = p_i232159_15_;
      this.field_237359_s_ = p_i232159_16_;
      this.field_237358_r_ = p_i232159_17_;
      this.field_237360_t_ = p_i232159_18_;
      this.field_237361_u_ = p_i232159_19_;
      this.field_237362_v_ = p_i232159_20_;
      this.field_237365_y_ = p_i232159_21_;
      this.field_237366_z_ = p_i232159_22_;
      this.field_237337_A_ = p_i232159_23_;
      this.field_237338_B_ = p_i232159_24_;
      this.field_237353_m_ = p_i232159_3_;
      this.field_237351_k_ = p_i232159_2_;
      this.field_237340_D_ = p_i232159_25_;
      this.field_237364_x_ = p_i232159_26_;
      this.field_237363_w_ = p_i232159_27_;
      this.field_237342_b_ = p_i232159_28_;
      this.field_237343_c_ = p_i232159_29_;
      this.field_237344_d_ = p_i232159_30_;
   }

   public ServerWorldInfo(WorldSettings p_i232158_1_, DimensionGeneratorSettings p_i232158_2_, Lifecycle p_i232158_3_) {
      this((DataFixer)null, SharedConstants.getVersion().getWorldVersion(), (CompoundNBT)null, false, 0, 0, 0, 0L, 0L, 19133, 0, 0, false, 0, false, false, false, WorldBorder.field_235925_b_, 0, 0, (UUID)null, Sets.newLinkedHashSet(), new TimerCallbackManager<>(TimerCallbackSerializers.field_216342_a), (CompoundNBT)null, new CompoundNBT(), p_i232158_1_.func_234959_h_(), p_i232158_2_, p_i232158_3_);
   }
