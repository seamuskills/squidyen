...
public final class Dimension {
   public static final MapCodec<Dimension> field_236052_a_ = RecordCodecBuilder.mapCodec((p_236061_0_) -> {
   ...
   public static boolean func_236060_a_(long p_236060_0_, SimpleRegistry<Dimension> p_236060_2_) {
      ...
      if (list.size() != field_236056_e_.size()) {
         ...
         if (entry.getKey() == field_236053_b_ && entry1.getKey() == field_236054_c_ && entry2.getKey() == field_236055_d_) {
            if (entry.getValue().func_236063_b_() != DimensionType.field_236004_h_ && entry.getValue().func_236063_b_() != DimensionType.field_241498_j_) {
               return false;
            } else if (entry1.getValue().func_236063_b_() != DimensionType.field_236005_i_) {
               return false;
            } else if (entry2.getValue().func_236063_b_() != DimensionType.field_236006_j_) {
               return false;
               ...
               if (!noisechunkgenerator.func_236088_a_(p_236060_0_, DimensionSettings.Preset.field_236124_d_)) {
                  return false;
               } else if (!noisechunkgenerator1.func_236088_a_(p_236060_0_, DimensionSettings.Preset.field_236125_e_)) {
                  return false;
