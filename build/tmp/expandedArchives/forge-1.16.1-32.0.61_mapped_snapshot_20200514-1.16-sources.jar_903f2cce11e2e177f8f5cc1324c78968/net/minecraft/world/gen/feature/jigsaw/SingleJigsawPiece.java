...
public class SingleJigsawPiece extends JigsawPiece {
   ...
   protected static <E extends SingleJigsawPiece> RecordCodecBuilder<E, List<StructureProcessor>> func_236844_b_() {
      return IStructureProcessorType.field_237137_i_.listOf().fieldOf("processors").forGetter((p_236845_0_) -> {
   ...
   public SingleJigsawPiece(String p_i51400_1_, List<StructureProcessor> p_i51400_2_) {
      this(Either.left(new ResourceLocation(p_i51400_1_)), p_i51400_2_, JigsawPattern.PlacementBehaviour.RIGID);
   }

   protected SingleJigsawPiece(Either<ResourceLocation, Template> p_i232049_1_, List<StructureProcessor> p_i232049_2_, JigsawPattern.PlacementBehaviour p_i232049_3_) {
      super(p_i232049_3_);
      this.field_236839_c_ = p_i232049_1_;
      this.processors = ImmutableList.copyOf(p_i232049_2_);
   }

   public SingleJigsawPiece(Template p_i232050_1_, List<StructureProcessor> p_i232050_2_, JigsawPattern.PlacementBehaviour p_i232050_3_) {
      this(Either.right(p_i232050_1_), p_i232050_2_, p_i232050_3_);
   }
