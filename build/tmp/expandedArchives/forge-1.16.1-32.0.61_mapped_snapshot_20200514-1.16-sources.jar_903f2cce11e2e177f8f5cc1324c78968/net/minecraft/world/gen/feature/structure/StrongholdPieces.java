...
public class StrongholdPieces {
   ...
   public static class ChestCorridor extends StrongholdPieces.Stronghold {
      ...
      public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_) {
         ...
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, this.entryDoor, 1, 1, 0);
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 6);
   ...
   public static class Library extends StrongholdPieces.Stronghold {
      ...
      public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_) {
         ...
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, this.entryDoor, 4, 1, 0);
   ...
   public static class PortalRoom extends StrongholdPieces.Stronghold {
      ...
      public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_) {
         ...
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, StrongholdPieces.Stronghold.Door.GRATES, 4, 1, 0);
         int i = 6;
   ...
   public static class Stairs extends StrongholdPieces.Stronghold {
      ...
      public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_) {
         ...
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, this.entryDoor, 1, 7, 0);
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 4);
   ...
   public static class StairsStraight extends StrongholdPieces.Stronghold {
      ...
      public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_) {
         ...
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, this.entryDoor, 1, 7, 0);
         this.placeDoor(p_230383_1_, p_230383_4_, p_230383_5_, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 7);
