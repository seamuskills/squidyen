...
public abstract class AbstractBigMushroomFeature extends Feature<BigMushroomFeatureConfig> {
   ...
   public boolean func_230362_a_(ISeedReader p_230362_1_, StructureManager p_230362_2_, ChunkGenerator p_230362_3_, Random p_230362_4_, BlockPos p_230362_5_, BigMushroomFeatureConfig p_230362_6_) {
      int i = this.func_227211_a_(p_230362_4_);
      BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable();
      if (!this.func_227209_a_(p_230362_1_, p_230362_5_, i, blockpos$mutable, p_230362_6_)) {
         return false;
      } else {
         this.func_225564_a_(p_230362_1_, p_230362_4_, p_230362_5_, i, blockpos$mutable, p_230362_6_);
         this.func_227210_a_(p_230362_1_, p_230362_4_, p_230362_5_, p_230362_6_, i, blockpos$mutable);
         return true;
      }
   }
