...
public class IcebergFeature extends Feature<BlockStateFeatureConfig> {
   ...
   public boolean func_230362_a_(ISeedReader p_230362_1_, StructureManager p_230362_2_, ChunkGenerator p_230362_3_, Random p_230362_4_, BlockPos p_230362_5_, BlockStateFeatureConfig p_230362_6_) {
      p_230362_5_ = new BlockPos(p_230362_5_.getX(), p_230362_3_.func_230356_f_(), p_230362_5_.getZ());
      boolean flag = p_230362_4_.nextDouble() > 0.7D;
      BlockState blockstate = p_230362_6_.state;
      double d0 = p_230362_4_.nextDouble() * 2.0D * Math.PI;
      int i = 11 - p_230362_4_.nextInt(5);
      int j = 3 + p_230362_4_.nextInt(3);
      boolean flag1 = p_230362_4_.nextDouble() > 0.7D;
      int k = 11;
      int l = flag1 ? p_230362_4_.nextInt(6) + 6 : p_230362_4_.nextInt(15) + 3;
      if (!flag1 && p_230362_4_.nextDouble() > 0.9D) {
         l += p_230362_4_.nextInt(19) + 7;
      }

      int i1 = Math.min(l + p_230362_4_.nextInt(11), 18);
      int j1 = Math.min(l + p_230362_4_.nextInt(7) - p_230362_4_.nextInt(5), 11);
      int k1 = flag1 ? i : 11;

      for(int l1 = -k1; l1 < k1; ++l1) {
         for(int i2 = -k1; i2 < k1; ++i2) {
            for(int j2 = 0; j2 < l; ++j2) {
               int k2 = flag1 ? this.func_205178_b(j2, l, j1) : this.func_205183_a(p_230362_4_, j2, l, j1);
               if (flag1 || l1 < k2) {
                  this.func_205181_a(p_230362_1_, p_230362_4_, p_230362_5_, l, l1, j2, i2, k2, k1, flag1, j, d0, flag, blockstate);
               }
            }
         }
      }

      this.func_205186_a(p_230362_1_, p_230362_5_, j1, l, flag1, i);
      ...
      for(int i3 = -k1; i3 < k1; ++i3) {
         for(int j3 = -k1; j3 < k1; ++j3) {
            for(int k3 = -1; k3 > -i1; --k3) {
               ...
               int l2 = this.func_205187_b(p_230362_4_, -k3, i1, j1);
               if (i3 < l2) {
                  this.func_205181_a(p_230362_1_, p_230362_4_, p_230362_5_, i1, i3, k3, j3, l2, l3, flag1, j, d0, flag, blockstate);
               }
            }
         }
      }

      boolean flag2 = flag1 ? p_230362_4_.nextDouble() > 0.1D : p_230362_4_.nextDouble() > 0.7D;
      if (flag2) {
         this.func_205184_a(p_230362_4_, p_230362_1_, j1, l, p_230362_5_, flag1, i, d0, j);
      }
