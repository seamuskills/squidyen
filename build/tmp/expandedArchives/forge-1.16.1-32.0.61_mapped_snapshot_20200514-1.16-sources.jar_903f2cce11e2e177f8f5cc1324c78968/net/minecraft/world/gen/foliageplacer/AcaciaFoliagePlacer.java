...
public class AcaciaFoliagePlacer extends FoliagePlacer {
   public static final Codec<AcaciaFoliagePlacer> field_236736_a_ = RecordCodecBuilder.create((p_236737_0_) -> {
      return func_236756_b_(p_236737_0_).apply(p_236737_0_, AcaciaFoliagePlacer::new);
   });

   public AcaciaFoliagePlacer(int p_i232027_1_, int p_i232027_2_, int p_i232027_3_, int p_i232027_4_) {
      super(p_i232027_1_, p_i232027_2_, p_i232027_3_, p_i232027_4_);
   }
