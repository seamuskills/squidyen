...
public class JungleFoliagePlacer extends FoliagePlacer {
   public static final Codec<JungleFoliagePlacer> field_236774_a_ = RecordCodecBuilder.create((p_236776_0_) -> {
      return func_236756_b_(p_236776_0_).and(Codec.INT.fieldOf("height").forGetter((p_236777_0_) -> {
         return p_236777_0_.field_236775_b_;
      })).apply(p_236776_0_, JungleFoliagePlacer::new);
   });
   protected final int field_236775_b_;

   public JungleFoliagePlacer(int p_i232037_1_, int p_i232037_2_, int p_i232037_3_, int p_i232037_4_, int p_i232037_5_) {
      super(p_i232037_1_, p_i232037_2_, p_i232037_3_, p_i232037_4_);
      this.field_236775_b_ = p_i232037_5_;
   }
