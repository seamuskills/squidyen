...
public class DarkOakFoliagePlacer extends FoliagePlacer {
   public static final Codec<DarkOakFoliagePlacer> field_236745_a_ = RecordCodecBuilder.create((p_236746_0_) -> {
      return func_236756_b_(p_236746_0_).apply(p_236746_0_, DarkOakFoliagePlacer::new);
   });

   public DarkOakFoliagePlacer(int p_i232032_1_, int p_i232032_2_, int p_i232032_3_, int p_i232032_4_) {
      super(p_i232032_1_, p_i232032_2_, p_i232032_3_, p_i232032_4_);
   }
