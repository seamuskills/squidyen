...
public class GravityStructureProcessor extends StructureProcessor {
   public static final Codec<GravityStructureProcessor> field_237081_a_ = RecordCodecBuilder.create((p_237082_0_) -> {
      return p_237082_0_.group(Heightmap.Type.field_236078_g_.fieldOf("heightmap").withDefault(Heightmap.Type.WORLD_SURFACE_WG).forGetter((p_237084_0_) -> {
         return p_237084_0_.heightmap;
      }), Codec.INT.fieldOf("offset").withDefault(0).forGetter((p_237083_0_) -> {
