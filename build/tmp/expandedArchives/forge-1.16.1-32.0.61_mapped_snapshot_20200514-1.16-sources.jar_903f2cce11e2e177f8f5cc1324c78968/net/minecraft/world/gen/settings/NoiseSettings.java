...
public class NoiseSettings {
   public static final Codec<NoiseSettings> field_236156_a_ = RecordCodecBuilder.create((p_236170_0_) -> {
      return p_236170_0_.group(RangeCodec.func_232989_a_(0, 256).fieldOf("height").forGetter(NoiseSettings::func_236169_a_), ScalingSettings.field_236145_a_.fieldOf("sampling").forGetter(NoiseSettings::func_236171_b_), SlideSettings.field_236182_a_.fieldOf("top_slide").forGetter(NoiseSettings::func_236172_c_), SlideSettings.field_236182_a_.fieldOf("bottom_slide").forGetter(NoiseSettings::func_236173_d_), RangeCodec.func_232989_a_(1, 4).fieldOf("size_horizontal").forGetter(NoiseSettings::func_236174_e_), RangeCodec.func_232989_a_(1, 4).fieldOf("size_vertical").forGetter(NoiseSettings::func_236175_f_), Codec.DOUBLE.fieldOf("density_factor").forGetter(NoiseSettings::func_236176_g_), Codec.DOUBLE.fieldOf("density_offset").forGetter(NoiseSettings::func_236177_h_), Codec.BOOL.fieldOf("simplex_surface_noise").forGetter(NoiseSettings::func_236178_i_), Codec.BOOL.optionalFieldOf("random_density_offset", Boolean.valueOf(false), Lifecycle.experimental()).forGetter(NoiseSettings::func_236179_j_), Codec.BOOL.optionalFieldOf("island_noise_override", Boolean.valueOf(false), Lifecycle.experimental()).forGetter(NoiseSettings::func_236180_k_), Codec.BOOL.optionalFieldOf("amplified", Boolean.valueOf(false), Lifecycle.experimental()).forGetter(NoiseSettings::func_236181_l_)).apply(p_236170_0_, NoiseSettings::new);
   });
