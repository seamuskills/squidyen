...
public class OceanRuinStructure extends Structure<OceanRuinConfig> {
   ...
   public static class Start extends StructureStart<OceanRuinConfig> {
      ...
      public void func_230364_a_(ChunkGenerator p_230364_1_, TemplateManager p_230364_2_, int p_230364_3_, int p_230364_4_, Biome p_230364_5_, OceanRuinConfig p_230364_6_) {
         int i = p_230364_3_ * 16;
         int j = p_230364_4_ * 16;
         BlockPos blockpos = new BlockPos(i, 90, j);
         Rotation rotation = Rotation.randomRotation(this.rand);
         OceanRuinPieces.func_204041_a(p_230364_2_, blockpos, rotation, this.components, this.rand, p_230364_6_);
