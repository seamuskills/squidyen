...
public class StructureSpreadSettings {
   public static final Codec<StructureSpreadSettings> field_236656_a_ = RecordCodecBuilder.create((p_236661_0_) -> {
      return p_236661_0_.group(RangeCodec.func_232989_a_(0, 1023).fieldOf("distance").forGetter(StructureSpreadSettings::func_236660_a_), RangeCodec.func_232989_a_(0, 1023).fieldOf("spread").forGetter(StructureSpreadSettings::func_236662_b_), RangeCodec.func_232989_a_(1, 4095).fieldOf("count").forGetter(StructureSpreadSettings::func_236663_c_)).apply(p_236661_0_, StructureSpreadSettings::new);
   });
