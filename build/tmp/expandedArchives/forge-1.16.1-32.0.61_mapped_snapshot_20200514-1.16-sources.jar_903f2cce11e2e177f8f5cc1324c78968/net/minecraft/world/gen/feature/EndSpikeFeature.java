...
public class EndSpikeFeature extends Feature<EndSpikeFeatureConfig> {
   ...
   public boolean func_230362_a_(ISeedReader p_230362_1_, StructureManager p_230362_2_, ChunkGenerator p_230362_3_, Random p_230362_4_, BlockPos p_230362_5_, EndSpikeFeatureConfig p_230362_6_) {
      List<EndSpikeFeature.EndSpike> list = p_230362_6_.getSpikes();
      if (list.isEmpty()) {
         list = func_236356_a_(p_230362_1_);
      }

      for(EndSpikeFeature.EndSpike endspikefeature$endspike : list) {
         if (endspikefeature$endspike.doesStartInChunk(p_230362_5_)) {
            this.placeSpike(p_230362_1_, p_230362_4_, p_230362_6_, endspikefeature$endspike);
         }
      }
   ...
   public static class EndSpike {
      public static final Codec<EndSpikeFeature.EndSpike> field_236357_a_ = RecordCodecBuilder.create((p_236359_0_) -> {
         return p_236359_0_.group(Codec.INT.fieldOf("centerX").withDefault(0).forGetter((p_236363_0_) -> {
            return p_236363_0_.centerX;
         }), Codec.INT.fieldOf("centerZ").withDefault(0).forGetter((p_236362_0_) -> {
            return p_236362_0_.centerZ;
         }), Codec.INT.fieldOf("radius").withDefault(0).forGetter((p_236361_0_) -> {
            return p_236361_0_.radius;
         }), Codec.INT.fieldOf("height").withDefault(0).forGetter((p_236360_0_) -> {
            return p_236360_0_.height;
         }), Codec.BOOL.fieldOf("guarded").withDefault(false).forGetter((p_236358_0_) -> {
