...
public class MineshaftStructure extends Structure<MineshaftConfig> {
   ...
   public static class Start extends StructureStart<MineshaftConfig> {
      ...
      public void func_230364_a_(ChunkGenerator p_230364_1_, TemplateManager p_230364_2_, int p_230364_3_, int p_230364_4_, Biome p_230364_5_, MineshaftConfig p_230364_6_) {
         MineshaftPieces.Room mineshaftpieces$room = new MineshaftPieces.Room(0, this.rand, (p_230364_3_ << 4) + 2, (p_230364_4_ << 4) + 2, p_230364_6_.type);
         ...
         if (p_230364_6_.type == MineshaftStructure.Type.MESA) {
            int i = -5;
            int j = p_230364_1_.func_230356_f_() - this.bounds.maxY + this.bounds.getYSize() / 2 - -5;
