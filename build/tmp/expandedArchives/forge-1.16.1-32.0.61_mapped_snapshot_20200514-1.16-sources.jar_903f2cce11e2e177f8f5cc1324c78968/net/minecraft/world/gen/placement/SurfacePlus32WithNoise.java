...
public class SurfacePlus32WithNoise extends Placement<NoiseDependant> {
   public SurfacePlus32WithNoise(Codec<NoiseDependant> p_i232092_1_) {
      super(p_i232092_1_);
   }

   public Stream<BlockPos> getPositions(IWorld worldIn, ChunkGenerator generatorIn, Random random, NoiseDependant configIn, BlockPos pos) {
