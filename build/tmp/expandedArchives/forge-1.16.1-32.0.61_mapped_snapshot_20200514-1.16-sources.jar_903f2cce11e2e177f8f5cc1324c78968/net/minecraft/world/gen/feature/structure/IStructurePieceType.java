...
public interface IStructurePieceType {
   ...
   IStructurePieceType field_236401_af_ = register(BastionRemnantsPieces.Bastion::new, "BastionRemnant");
   IStructurePieceType field_236402_ag_ = register(JigsawTileEntity.RuntimePiece::new, "Runtime");
