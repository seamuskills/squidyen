...
public class SlideSettings {
   public static final Codec<SlideSettings> field_236182_a_ = RecordCodecBuilder.create((p_236187_0_) -> {
      return p_236187_0_.group(Codec.INT.fieldOf("target").forGetter(SlideSettings::func_236186_a_), RangeCodec.func_232989_a_(0, 256).fieldOf("size").forGetter(SlideSettings::func_236188_b_), Codec.INT.fieldOf("offset").forGetter(SlideSettings::func_236189_c_)).apply(p_236187_0_, SlideSettings::new);
   });
