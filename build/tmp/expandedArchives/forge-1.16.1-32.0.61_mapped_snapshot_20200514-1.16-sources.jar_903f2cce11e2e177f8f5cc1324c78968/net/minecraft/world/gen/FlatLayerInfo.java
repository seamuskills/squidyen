...
public class FlatLayerInfo {
   public static final Codec<FlatLayerInfo> field_236929_a_ = RecordCodecBuilder.create((p_236930_0_) -> {
      return p_236930_0_.group(RangeCodec.func_232989_a_(0, 256).fieldOf("height").forGetter(FlatLayerInfo::getLayerCount), Registry.BLOCK.fieldOf("block").withDefault(Blocks.AIR).forGetter((p_236931_0_) -> {
