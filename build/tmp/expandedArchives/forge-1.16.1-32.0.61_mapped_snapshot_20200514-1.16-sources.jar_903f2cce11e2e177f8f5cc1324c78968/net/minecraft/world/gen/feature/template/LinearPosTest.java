...
public class LinearPosTest extends PosRuleTest {
   public static final Codec<LinearPosTest> field_237087_a_ = RecordCodecBuilder.create((p_237092_0_) -> {
      return p_237092_0_.group(Codec.FLOAT.fieldOf("min_chance").withDefault(0.0F).forGetter((p_237096_0_) -> {
         return p_237096_0_.field_237088_b_;
      }), Codec.FLOAT.fieldOf("max_chance").withDefault(0.0F).forGetter((p_237095_0_) -> {
         return p_237095_0_.field_237089_d_;
      }), Codec.INT.fieldOf("min_dist").withDefault(0).forGetter((p_237094_0_) -> {
         return p_237094_0_.field_237090_e_;
      }), Codec.INT.fieldOf("max_dist").withDefault(0).forGetter((p_237093_0_) -> {
