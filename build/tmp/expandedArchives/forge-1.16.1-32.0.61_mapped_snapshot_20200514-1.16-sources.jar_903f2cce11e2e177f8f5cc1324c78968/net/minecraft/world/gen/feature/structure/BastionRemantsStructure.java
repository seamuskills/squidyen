...
public class BastionRemantsStructure extends Structure<BastionRemnantConfig> {
   public BastionRemantsStructure(Codec<BastionRemnantConfig> p_i231927_1_) {
      super(p_i231927_1_);
   }
   ...
   public static class Start extends MarginedStructureStart<BastionRemnantConfig> {
      public Start(Structure<BastionRemnantConfig> p_i231928_1_, int p_i231928_2_, int p_i231928_3_, MutableBoundingBox p_i231928_4_, int p_i231928_5_, long p_i231928_6_) {
         super(p_i231928_1_, p_i231928_2_, p_i231928_3_, p_i231928_4_, p_i231928_5_, p_i231928_6_);
      }
