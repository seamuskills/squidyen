...
public class AxisAlignedLinearPosTest extends PosRuleTest {
   public static final Codec<AxisAlignedLinearPosTest> field_237045_a_ = RecordCodecBuilder.create((p_237051_0_) -> {
      return p_237051_0_.group(Codec.FLOAT.fieldOf("min_chance").withDefault(0.0F).forGetter((p_237056_0_) -> {
         return p_237056_0_.field_237046_b_;
      }), Codec.FLOAT.fieldOf("max_chance").withDefault(0.0F).forGetter((p_237055_0_) -> {
         return p_237055_0_.field_237047_d_;
      }), Codec.INT.fieldOf("min_dist").withDefault(0).forGetter((p_237054_0_) -> {
         return p_237054_0_.field_237048_e_;
      }), Codec.INT.fieldOf("max_dist").withDefault(0).forGetter((p_237053_0_) -> {
         return p_237053_0_.field_237049_f_;
      }), Direction.Axis.field_239632_d_.fieldOf("axis").withDefault(Direction.Axis.Y).forGetter((p_237052_0_) -> {
