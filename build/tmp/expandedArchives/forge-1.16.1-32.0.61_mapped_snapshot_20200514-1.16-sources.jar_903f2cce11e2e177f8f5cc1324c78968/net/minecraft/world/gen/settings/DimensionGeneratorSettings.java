...
public class DimensionGeneratorSettings {
   ...
   public static NoiseChunkGenerator func_236211_a_(long p_236211_0_) {
      return new NoiseChunkGenerator(new OverworldBiomeProvider(p_236211_0_, false, false), p_236211_0_, DimensionSettings.Preset.field_236122_b_.func_236137_b_());
   }
   ...
   public static SimpleRegistry<Dimension> func_236216_a_(SimpleRegistry<Dimension> p_236216_0_, ChunkGenerator p_236216_1_) {
      Dimension dimension = p_236216_0_.func_230516_a_(Dimension.field_236053_b_);
      Supplier<DimensionType> supplier = () -> {
         return dimension == null ? DimensionType.func_236019_a_() : dimension.func_236063_b_();
      };
   ...
   public static SimpleRegistry<Dimension> func_241520_a_(SimpleRegistry<Dimension> p_241520_0_, Supplier<DimensionType> p_241520_1_, ChunkGenerator p_241520_2_) {
      ...
      simpleregistry.register(Dimension.field_236053_b_, new Dimension(p_241520_1_, p_241520_2_));
      simpleregistry.func_239662_d_(Dimension.field_236053_b_);
   ...
   public ChunkGenerator func_236225_f_() {
      ...
      return (ChunkGenerator)(dimension == null ? func_236211_a_((new Random()).nextLong()) : dimension.func_236064_c_());
   }
   ...
   public DimensionGeneratorSettings func_236215_a_(SimpleRegistry<Dimension> p_236215_1_) {
      return new DimensionGeneratorSettings(this.field_236205_e_, this.field_236206_f_, this.field_236207_g_, p_236215_1_);
   }
   ...
   public static DimensionGeneratorSettings func_236219_a_(Properties p_236219_0_) {
      ...
      case 0:
         ...
         return new DimensionGeneratorSettings(i, flag, false, func_236216_a_(simpleregistry, new FlatChunkGenerator(FlatGenerationSettings.field_236932_a_.parse(dynamic).resultOrPartial(field_236203_c_::error).orElseGet(FlatGenerationSettings::getDefaultFlatGenerator))));
      case 1:
         return new DimensionGeneratorSettings(i, flag, false, func_236216_a_(simpleregistry, DebugChunkGenerator.field_236065_d_));
      case 2:
         return new DimensionGeneratorSettings(i, flag, false, func_236216_a_(simpleregistry, new NoiseChunkGenerator(new OverworldBiomeProvider(i, false, false), i, DimensionSettings.Preset.field_236123_c_.func_236137_b_())));
      case 3:
         return new DimensionGeneratorSettings(i, flag, false, func_236216_a_(simpleregistry, new NoiseChunkGenerator(new OverworldBiomeProvider(i, false, true), i, DimensionSettings.Preset.field_236122_b_.func_236137_b_())));
      default:
   ...
   public DimensionGeneratorSettings func_236220_a_(boolean p_236220_1_, OptionalLong p_236220_2_) {
      ...
      if (p_236220_2_.isPresent()) {
         ...
         for(Entry<RegistryKey<Dimension>, Dimension> entry : this.field_236208_h_.func_239659_c_()) {
            RegistryKey<Dimension> registrykey = entry.getKey();
            simpleregistry.register(registrykey, new Dimension(entry.getValue().func_236059_a_(), entry.getValue().func_236064_c_().func_230349_a_(j)));
