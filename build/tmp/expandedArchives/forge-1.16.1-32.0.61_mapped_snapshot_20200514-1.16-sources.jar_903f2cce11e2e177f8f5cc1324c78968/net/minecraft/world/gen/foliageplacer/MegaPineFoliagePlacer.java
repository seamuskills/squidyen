...
public class MegaPineFoliagePlacer extends FoliagePlacer {
   public static final Codec<MegaPineFoliagePlacer> field_236778_a_ = RecordCodecBuilder.create((p_236781_0_) -> {
      return func_236756_b_(p_236781_0_).and(p_236781_0_.group(Codec.INT.fieldOf("height_random").forGetter((p_236783_0_) -> {
         return p_236783_0_.field_236779_b_;
      }), Codec.INT.fieldOf("crown_height").forGetter((p_236782_0_) -> {
         return p_236782_0_.field_236780_c_;
      }))).apply(p_236781_0_, MegaPineFoliagePlacer::new);
   });
   private final int field_236779_b_;
   private final int field_236780_c_;

   public MegaPineFoliagePlacer(int p_i232038_1_, int p_i232038_2_, int p_i232038_3_, int p_i232038_4_, int p_i232038_5_, int p_i232038_6_) {
      super(p_i232038_1_, p_i232038_2_, p_i232038_3_, p_i232038_4_);
      this.field_236779_b_ = p_i232038_5_;
      this.field_236780_c_ = p_i232038_6_;
   }
   ...
   public int func_230374_a_(Random p_230374_1_, int p_230374_2_, BaseTreeFeatureConfig p_230374_3_) {
      return p_230374_1_.nextInt(this.field_236779_b_ + 1) + this.field_236780_c_;
   }
