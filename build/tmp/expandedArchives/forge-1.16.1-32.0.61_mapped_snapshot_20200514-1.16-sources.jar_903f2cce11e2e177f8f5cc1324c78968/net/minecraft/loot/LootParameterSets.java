...
public class LootParameterSets {
   ...
   public static final LootParameterSet FISHING = register("fishing", (p_216258_0_) -> {
      p_216258_0_.required(LootParameters.POSITION).required(LootParameters.TOOL).optional(LootParameters.THIS_ENTITY);
   ...
   public static final LootParameterSet ADVANCEMENT = register("advancement_reward", (p_227560_0_) -> {
      p_227560_0_.required(LootParameters.THIS_ENTITY).required(LootParameters.POSITION);
   });
   public static final LootParameterSet field_237454_j_ = register("advancement_entity", (p_227559_0_) -> {
      p_227559_0_.required(LootParameters.THIS_ENTITY).required(LootParameters.field_237457_g_).required(LootParameters.POSITION);
   });
   ...
   public static final LootParameterSet BLOCK = register("block", (p_237455_0_) -> {
      p_237455_0_.required(LootParameters.BLOCK_STATE).required(LootParameters.POSITION).required(LootParameters.TOOL).optional(LootParameters.THIS_ENTITY).optional(LootParameters.BLOCK_ENTITY).optional(LootParameters.EXPLOSION_RADIUS);
   });
