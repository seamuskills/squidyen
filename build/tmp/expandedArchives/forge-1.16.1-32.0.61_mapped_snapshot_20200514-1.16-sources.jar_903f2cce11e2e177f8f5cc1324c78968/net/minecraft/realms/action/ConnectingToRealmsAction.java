...
public class ConnectingToRealmsAction extends LongRunningTask {
   ...
   public void run() {
      this.func_224989_b(I18n.format("mco.connect.connecting"));
               ...
               func_238127_a_(new RealmsLongConfirmationScreen((p_238121_2_) -> {
                  try {
                     if (p_238121_2_) {
                        ...
                        try {
                           Minecraft.getInstance().getPackFinder().downloadResourcePack(realmsserveraddress_f.field_230602_b_, realmsserveraddress_f.field_230603_c_).thenRun(() -> {
