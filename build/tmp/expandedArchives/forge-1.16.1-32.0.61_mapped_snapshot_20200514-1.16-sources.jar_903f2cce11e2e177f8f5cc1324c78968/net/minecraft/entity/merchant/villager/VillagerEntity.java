...
public class VillagerEntity extends AbstractVillagerEntity implements IReputationTracking, IVillagerDataHolder {
   ...
   public VillagerEntity createChild(AgeableEntity ageable) {
      ...
      if (d0 < 0.5D) {
         ivillagertype = IVillagerType.byBiome(this.world.getBiome(this.func_233580_cy_()));
      } else if (d0 < 0.75D) {
      ...
      villagerentity.onInitialSpawn(this.world, this.world.getDifficultyForLocation(villagerentity.func_233580_cy_()), SpawnReason.BREEDING, (ILivingEntityData)null, (CompoundNBT)null);
