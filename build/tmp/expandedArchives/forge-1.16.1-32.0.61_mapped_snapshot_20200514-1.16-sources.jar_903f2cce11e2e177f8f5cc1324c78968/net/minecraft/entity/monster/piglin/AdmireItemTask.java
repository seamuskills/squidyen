...
public class AdmireItemTask<E extends PiglinEntity> extends Task<E> {
   ...
   public AdmireItemTask(int p_i231573_1_) {
      super(ImmutableMap.of(MemoryModuleType.field_234076_J_, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.field_234080_N_, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_234081_O_, MemoryModuleStatus.VALUE_ABSENT));
