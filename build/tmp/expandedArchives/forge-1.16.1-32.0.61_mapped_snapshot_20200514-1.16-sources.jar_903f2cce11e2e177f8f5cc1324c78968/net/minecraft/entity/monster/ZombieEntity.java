...
public class ZombieEntity extends MonsterEntity {
      ...
      if (super.attackEntityFrom(source, amount)) {
         ...
         if (event.getResult() == net.minecraftforge.eventbus.api.Event.Result.ALLOW  ||
            ...
            for(int l = 0; l < 50; ++l) {
               ...
               if (WorldEntitySpawner.canCreatureTypeSpawnAtLocation(entityspawnplacementregistry$placementtype, this.world, blockpos, entitytype) && EntitySpawnPlacementRegistry.func_223515_a(entitytype, this.world, SpawnReason.REINFORCEMENT, blockpos, this.world.rand)) {
                  ...
                  if (!this.world.isPlayerWithin((double)i1, (double)j1, (double)k1, 7.0D) && this.world.checkNoEntityCollision(zombieentity) && this.world.hasNoCollisions(zombieentity) && !this.world.containsAnyLiquid(zombieentity.getBoundingBox())) {
                     ...
                     zombieentity.onInitialSpawn(this.world, this.world.getDifficultyForLocation(zombieentity.func_233580_cy_()), SpawnReason.REINFORCEMENT, (ILivingEntityData)null, (CompoundNBT)null);
   ...
   public void onKillEntity(LivingEntity entityLivingIn) {
      ...
      if ((this.world.getDifficulty() == Difficulty.NORMAL || this.world.getDifficulty() == Difficulty.HARD) && entityLivingIn instanceof VillagerEntity) {
         ...
         zombievillagerentity.onInitialSpawn(this.world, this.world.getDifficultyForLocation(zombievillagerentity.func_233580_cy_()), SpawnReason.CONVERSION, new ZombieEntity.GroupData(false, true), (CompoundNBT)null);
         ...
         if (!this.isSilent()) {
            this.world.playEvent((PlayerEntity)null, 1026, this.func_233580_cy_(), 0);
         }
      }
