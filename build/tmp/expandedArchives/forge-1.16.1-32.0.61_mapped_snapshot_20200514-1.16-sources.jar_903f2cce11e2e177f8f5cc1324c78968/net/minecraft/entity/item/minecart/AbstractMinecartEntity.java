         ...
         for(Pose pose : immutablelist) {
            ...
            for(int i : field_234627_am_.get(pose)) {
               for(int[] aint1 : aint) {
                  ...
                  double d0 = this.world.func_234932_c_(blockpos$mutable, (p_234629_0_) -> {
                     if (p_234629_0_.func_235714_a_(BlockTags.field_232878_as_)) {
                        return true;
                     } else {
                        return p_234629_0_.getBlock() instanceof TrapDoorBlock && p_234629_0_.get(TrapDoorBlock.OPEN);
                     }
                  });
