...
public class MemoryModuleType<U> extends net.minecraftforge.registries.ForgeRegistryEntry<MemoryModuleType<?>> {
   ...
   public static final MemoryModuleType<PiglinEntity> field_234087_U_ = register("nearest_visible_baby_piglin");
   public static final MemoryModuleType<PlayerEntity> field_234088_V_ = register("nearest_targetable_player_not_wearing_gold");
   public static final MemoryModuleType<List<PiglinEntity>> field_234089_W_ = register("nearest_adult_piglins");
   public static final MemoryModuleType<List<PiglinEntity>> field_234090_X_ = register("nearest_visible_adult_piglins");
   public static final MemoryModuleType<List<HoglinEntity>> field_234091_Y_ = register("nearest_visible_adult_hoglins");
   public static final MemoryModuleType<PiglinEntity> field_234092_Z_ = register("nearest_visible_adult_piglin");
