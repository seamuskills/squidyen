   ...
   public int handleHookRetraction(ItemStack p_146034_1_) {
      ...
      if (!this.world.isRemote && playerentity != null) {
         ...
         if (this.caughtEntity != null) {
            ...
            LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withParameter(LootParameters.POSITION, this.func_233580_cy_()).withParameter(LootParameters.TOOL, p_146034_1_).withParameter(LootParameters.THIS_ENTITY, this).withRandom(this.rand).withLuck((float)this.luck + playerentity.getLuck());
