...
public class StriderEntity extends AnimalEntity implements IRideable, IEquipable {
   ...
   public StriderEntity createChild(AgeableEntity ageable) {
      return EntityType.field_233589_aE_.create(this.world);
   }
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ...
      if (striderentity$agedata$ridertype == StriderEntity.AgeData.RiderType.BABY_RIDER) {
         StriderEntity striderentity = EntityType.field_233589_aE_.create(worldIn.getWorld());
         ...
         ZombifiedPiglinEntity zombifiedpiglinentity = EntityType.field_233592_ba_.create(worldIn.getWorld());
