...
public abstract class PathNavigator {
   ...
   private boolean func_234112_b_(Vector3d p_234112_1_) {
      if (this.currentPath.getCurrentPathLength() <= this.currentPath.getCurrentPathIndex() + 1) {
         ...
         Vector3d vector3d = Vector3d.func_237492_c_(this.currentPath.getPathPointFromIndex(this.currentPath.getCurrentPathIndex()).func_224759_a());
         if (!p_234112_1_.func_237488_a_(vector3d, 2.0D)) {
            return false;
         } else {
            Vector3d vector3d1 = Vector3d.func_237492_c_(this.currentPath.getPathPointFromIndex(this.currentPath.getCurrentPathIndex() + 1).func_224759_a());
