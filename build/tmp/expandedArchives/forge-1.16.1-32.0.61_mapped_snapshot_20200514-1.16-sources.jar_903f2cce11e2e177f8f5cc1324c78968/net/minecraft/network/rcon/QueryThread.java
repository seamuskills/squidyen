...
public class QueryThread extends RConThread {
   ...
   public QueryThread(IServer p_i1536_1_) {
      ...
      this.field_232649_r_ = p_i1536_1_;
      ...
      this.worldName = p_i1536_1_.func_230542_k__();
   ...
   public void startThread() {
      if (!this.running) {
         if (0 < this.queryPort && 65535 >= this.queryPort) {
            ...
            field_232648_d_.warn("Invalid query port {} found in server.properties (queries disabled)", (int)this.queryPort);
         }
      }
   }
