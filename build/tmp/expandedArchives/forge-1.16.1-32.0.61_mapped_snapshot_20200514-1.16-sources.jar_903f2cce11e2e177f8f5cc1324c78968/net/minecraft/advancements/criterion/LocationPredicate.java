...
public class LocationPredicate {
   ...
   public static final LocationPredicate ANY = new LocationPredicate(MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, (Biome)null, (Structure<?>)null, (RegistryKey<World>)null, (Boolean)null, LightPredicate.field_226854_a_, BlockPredicate.field_226231_a_, FluidPredicate.field_226643_a_);
   ...
   public LocationPredicate(MinMaxBounds.FloatBound p_i231644_1_, MinMaxBounds.FloatBound p_i231644_2_, MinMaxBounds.FloatBound p_i231644_3_, @Nullable Biome p_i231644_4_, @Nullable Structure<?> p_i231644_5_, @Nullable RegistryKey<World> p_i231644_6_, @Nullable Boolean p_i231644_7_, LightPredicate p_i231644_8_, BlockPredicate p_i231644_9_, FluidPredicate p_i231644_10_) {
      this.x = p_i231644_1_;
      this.y = p_i231644_2_;
      this.z = p_i231644_3_;
      this.biome = p_i231644_4_;
      this.feature = p_i231644_5_;
      this.dimension = p_i231644_6_;
      this.field_235306_i_ = p_i231644_7_;
      this.field_226864_h_ = p_i231644_8_;
      this.field_226865_i_ = p_i231644_9_;
      this.field_226866_j_ = p_i231644_10_;
   }

   public static LocationPredicate forBiome(Biome p_204010_0_) {
      return new LocationPredicate(MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, p_204010_0_, (Structure<?>)null, (RegistryKey<World>)null, (Boolean)null, LightPredicate.field_226854_a_, BlockPredicate.field_226231_a_, FluidPredicate.field_226643_a_);
   }

   public static LocationPredicate func_235308_a_(RegistryKey<World> p_235308_0_) {
      return new LocationPredicate(MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, (Biome)null, (Structure<?>)null, p_235308_0_, (Boolean)null, LightPredicate.field_226854_a_, BlockPredicate.field_226231_a_, FluidPredicate.field_226643_a_);
   }

   public static LocationPredicate forFeature(Structure<?> p_218020_0_) {
      return new LocationPredicate(MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, (Biome)null, p_218020_0_, (RegistryKey<World>)null, (Boolean)null, LightPredicate.field_226854_a_, BlockPredicate.field_226231_a_, FluidPredicate.field_226643_a_);
   }
