...
public class EntityPredicate {
   ...
   public static LootContext func_234575_b_(ServerPlayerEntity p_234575_0_, Entity p_234575_1_) {
      return (new LootContext.Builder(p_234575_0_.getServerWorld())).withParameter(LootParameters.THIS_ENTITY, p_234575_1_).withParameter(LootParameters.POSITION, p_234575_1_.func_233580_cy_()).withParameter(LootParameters.field_237457_g_, p_234575_0_.getPositionVec()).withRandom(p_234575_0_.getRNG()).build(LootParameterSets.field_237454_j_);
   }
