...
public class FunctionManager {
   ...
   public void tick() {
      ...
      if (this.loadFunctionsRun) {
         ...
         Collection<FunctionObject> collection = this.field_240944_i_.func_240942_b_().getOrCreate(LOAD_TAG_ID).func_230236_b_();
   ...
   private void func_240948_b_(FunctionReloader p_240948_1_) {
      ...
      this.tickFunctions.addAll(p_240948_1_.func_240942_b_().getOrCreate(TICK_TAG_ID).func_230236_b_());
