            ...
            if (p_197447_0_.isTypeLimitedInversely() && !flag) {
               ...
               if (p_197447_0_.func_218115_f()) {
                  ...
                  p_197447_0_.addFilter((p_239573_2_) -> {
                     return p_239573_2_.getServer().getNetworkTagManager().getEntityTypes().getOrCreate(resourcelocation).func_230235_a_(p_239573_2_.getType()) != flag;
                  });
               } else {
            ...
            p_229367_0_.addFilter((p_229366_2_) -> {
               if (!(p_229366_2_.world instanceof ServerWorld)) {
                  ...
                  if (ilootcondition == null) {
                     ...
                     LootContext lootcontext = (new LootContext.Builder(serverworld)).withParameter(LootParameters.THIS_ENTITY, p_229366_2_).withParameter(LootParameters.POSITION, p_229366_2_.func_233580_cy_()).build(LootParameterSets.SELECTOR);
