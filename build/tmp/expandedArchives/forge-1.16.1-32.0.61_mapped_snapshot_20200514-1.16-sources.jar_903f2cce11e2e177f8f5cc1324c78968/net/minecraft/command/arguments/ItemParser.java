...
public class ItemParser {
   ...
   private static final BiFunction<SuggestionsBuilder, TagCollection<Item>, CompletableFuture<Suggestions>> DEFAULT_SUGGESTIONS_BUILDER = (p_239571_0_, p_239571_1_) -> {
   ...
   private BiFunction<SuggestionsBuilder, TagCollection<Item>, CompletableFuture<Suggestions>> suggestionsBuilder = DEFAULT_SUGGESTIONS_BUILDER;
    ...
    */
   private CompletableFuture<Suggestions> suggestItem(SuggestionsBuilder builder, TagCollection<Item> p_197328_2_) {
    ...
    */
   private CompletableFuture<Suggestions> suggestTag(SuggestionsBuilder builder, TagCollection<Item> p_201955_2_) {
    ...
    */
   private CompletableFuture<Suggestions> suggestTagOrItem(SuggestionsBuilder builder, TagCollection<Item> p_197331_2_) {
      if (this.allowTags) {
    ...
    */
   public CompletableFuture<Suggestions> fillSuggestions(SuggestionsBuilder builder, TagCollection<Item> p_197329_2_) {
