...
public class ServerRecipeBook extends RecipeBook {
   ...
   public CompoundNBT write() {
      ...
      compoundnbt.putBoolean("isBlastingFurnaceGuiOpen", this.field_216763_g);
      compoundnbt.putBoolean("isBlastingFurnaceFilteringCraftable", this.field_216764_h);
      compoundnbt.putBoolean("isSmokerGuiOpen", this.field_216765_i);
      compoundnbt.putBoolean("isSmokerFilteringCraftable", this.field_216766_j);
   ...
   public void read(CompoundNBT tag, RecipeManager p_192825_2_) {
      ...
      this.field_216763_g = tag.getBoolean("isBlastingFurnaceGuiOpen");
      this.field_216764_h = tag.getBoolean("isBlastingFurnaceFilteringCraftable");
      this.field_216765_i = tag.getBoolean("isSmokerGuiOpen");
      this.field_216766_j = tag.getBoolean("isSmokerFilteringCraftable");
