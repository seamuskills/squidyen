...
public class NetherPortalBlock extends Block {
   ...
   public static boolean trySpawnPortal(IWorld p_176548_0_, BlockPos worldIn) {
      NetherPortalBlock.Size netherportalblock$size = isPortal(p_176548_0_, worldIn);
      if (netherportalblock$size != null && !net.minecraftforge.event.ForgeEventFactory.onTrySpawnPortal(p_176548_0_, worldIn, netherportalblock$size)) {
   ...
   @Nullable
   public static NetherPortalBlock.Size isPortal(IWorld p_201816_0_, BlockPos worldIn) {
      NetherPortalBlock.Size netherportalblock$size = new NetherPortalBlock.Size(p_201816_0_, worldIn, Direction.Axis.X);
      if (netherportalblock$size.isValid() && netherportalblock$size.portalBlockCount == 0) {
         return netherportalblock$size;
      } else {
         NetherPortalBlock.Size netherportalblock$size1 = new NetherPortalBlock.Size(p_201816_0_, worldIn, Direction.Axis.Z);
   ...
   public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      ...
      return !flag && !facingState.isIn(this) && !(new NetherPortalBlock.Size(worldIn, currentPos, direction$axis1)).func_208508_f() ? Blocks.AIR.getDefaultState() : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
   }
   ...
   public static class Size {
      ...
      protected int getDistanceUntilEdge(BlockPos pos, Direction directionIn) {
         ...
         for(i = 0; i < 22; ++i) {
            ...
            if (!this.func_196900_a(this.world.getBlockState(blockpos)) || !this.world.getBlockState(blockpos.down()).isPortalFrame(world, blockpos.down())) {
               break;
            }
         }
