...
public class BedBlock extends HorizontalBlock implements ITileEntityProvider {
   ...
   public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
      if (worldIn.isRemote) {
         ...
         if (!func_235330_a_(worldIn)) {
            ...
            worldIn.func_230546_a_((Entity)null, DamageSource.func_233546_a_(), (IExplosionContext)null, (double)pos.getX() + 0.5D, (double)pos.getY() + 0.5D, (double)pos.getZ() + 0.5D, 5.0F, true, Explosion.Mode.DESTROY);
   ...
   public static Optional<Vector3d> func_220175_a(EntityType<?> p_220175_0_, IWorldReader p_220175_1_, BlockPos p_220175_2_) {
      ...
      if (voxelshape.getEnd(Direction.Axis.Y) > 0.4375D) {
         ...
         BlockPos.Mutable blockpos$mutable = p_220175_2_.func_239590_i_();
         ...
         if (voxelshape1.isEmpty()) {
            ...
            if ((double)p_220175_2_.getY() - d0 > 2.0D) {
               ...
               AxisAlignedBB axisalignedbb = p_220175_0_.func_220328_a(vector3d.x, vector3d.y, vector3d.z);
               return p_220175_1_.hasNoCollisions(axisalignedbb) && p_220175_1_.func_234853_a_(axisalignedbb.expand(0.0D, (double)-0.2F, 0.0D)).noneMatch(p_220175_0_::func_233597_a_) ? Optional.of(vector3d) : Optional.empty();
            }
         }
      }
   }
