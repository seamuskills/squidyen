...
public class RealmsMainScreen extends RealmsScreen {
            ...
            public void run() {
               try {
                  ...
                  if (realmsserver != null) {
                     ...
                     RealmsMainScreen.this.field_224020_i.func_231039_at__().removeIf((p_237669_1_) -> {
                     ...
                     RealmsMainScreen.this.field_224020_i.func_241215_a_((RealmsMainScreen.ListEntry)null);
                     RealmsMainScreen.this.func_223915_a((RealmsServer)null);
                     RealmsMainScreen.this.field_224021_j = -1L;
                     RealmsMainScreen.this.field_224022_k.field_230693_o_ = false;
                  }
               } catch (RealmsServiceException realmsserviceexception) {
   ...
   private void func_237605_b_(MatrixStack p_237605_1_, int p_237605_2_, int p_237605_3_) {
      ...
      List<ITextProperties> list = this.field_230712_o_.func_238425_b_(itextcomponent, 100);
      if (!this.field_223994_B) {
      ...
      for(ITextProperties itextproperties : list) {
         ++l;
         int i1 = j + 10 * l - 3;
         this.field_230712_o_.func_238422_b_(p_237605_1_, itextproperties, (float)(this.field_230708_k_ / 2 + 52), (float)i1, 5000268);
      }
   ...
   private void func_237581_a_(MatrixStack p_237581_1_, int p_237581_2_, int p_237581_3_, int p_237581_4_, int p_237581_5_, boolean p_237581_6_, boolean p_237581_7_) {
      ...
      if (flag4) {
         ...
         int i1 = this.field_230712_o_.getStringWidth(s1);
         this.func_238468_a_(p_237581_1_, j1 - 3, p_237581_3_ - 3, j1 + i1 + 3, p_237581_3_ + 8 + 3, -1073741824, -1073741824);
         this.field_230712_o_.func_238405_a_(p_237581_1_, s1, (float)j1, (float)p_237581_3_, -1);
      }
   ...
   protected void func_237583_a_(MatrixStack p_237583_1_, List<ITextComponent> p_237583_2_, int p_237583_3_, int p_237583_4_) {
      if (!p_237583_2_.isEmpty()) {
         ...
         for(ITextComponent itextcomponent1 : p_237583_2_) {
            ...
            this.field_230712_o_.func_238407_a_(p_237583_1_, itextcomponent1, (float)i1, (float)(j1 + i), 16777215);
            i += 10;
         }
   ...
   class ServerEntry extends RealmsMainScreen.ListEntry {
      ...
      private void func_237679_b_(RealmsServer p_237679_1_, MatrixStack p_237679_2_, int p_237679_3_, int p_237679_4_, int p_237679_5_, int p_237679_6_) {
         if (p_237679_1_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
            ...
            RealmsMainScreen.this.func_238471_a_(p_237679_2_, RealmsMainScreen.this.field_230712_o_, I18n.format("mco.selectServer.uninitialized"), p_237679_3_ + 10 + 40 + 75, p_237679_4_ + 12, j2);
         } else {
            int i = 225;
            int j = 2;
            ...
            if (RealmsMainScreen.this.func_223885_h(p_237679_1_) && p_237679_1_.field_230591_j_) {
               ...
               int l2 = RealmsMainScreen.this.field_230712_o_.getStringWidth(s3) + 17;
               int l = 16;
               int i1 = p_237679_3_ + RealmsMainScreen.this.field_230712_o_.getStringWidth(s2) + 8;
               int j1 = p_237679_4_ + 13;
               boolean flag = false;
               if (p_237679_5_ >= i1 && p_237679_5_ < i1 + l2 && p_237679_6_ > j1 && p_237679_6_ <= j1 + 16 & p_237679_6_ < RealmsMainScreen.this.field_230709_l_ - 40 && p_237679_6_ > 32 && !RealmsMainScreen.this.func_223990_b()) {
                  flag = true;
                  RealmsMainScreen.this.field_237539_ap_ = RealmsMainScreen.ServerState.EXPIRED;
               }

               int k1 = flag ? 2 : 1;
               AbstractGui.func_238463_a_(p_237679_2_, i1, j1, 0.0F, (float)(46 + k1 * 20), l2 / 2, 8, 256, 256);
               AbstractGui.func_238463_a_(p_237679_2_, i1 + l2 / 2, j1, (float)(200 - l2 / 2), (float)(46 + k1 * 20), l2 / 2, 8, 256, 256);
               AbstractGui.func_238463_a_(p_237679_2_, i1, j1 + 8, 0.0F, (float)(46 + k1 * 20 + 12), l2 / 2, 8, 256, 256);
               AbstractGui.func_238463_a_(p_237679_2_, i1 + l2 / 2, j1 + 8, (float)(200 - l2 / 2), (float)(46 + k1 * 20 + 12), l2 / 2, 8, 256, 256);
               RenderSystem.disableBlend();
               int l1 = p_237679_4_ + 11 + 5;
               int i2 = flag ? 16777120 : 16777215;
               RealmsMainScreen.this.field_230712_o_.func_238421_b_(p_237679_2_, s2, (float)(p_237679_3_ + 2), (float)(l1 + 1), 15553363);
               RealmsMainScreen.this.func_238471_a_(p_237679_2_, RealmsMainScreen.this.field_230712_o_, s3, i1 + l2 / 2, l1 + 1, i2);
            } else {
               if (p_237679_1_.field_230594_m_ == RealmsServer.ServerType.MINIGAME) {
                  int k2 = 13413468;
                  String s1 = I18n.format("mco.selectServer.minigame") + " ";
                  int k = RealmsMainScreen.this.field_230712_o_.getStringWidth(s1);
                  RealmsMainScreen.this.field_230712_o_.func_238421_b_(p_237679_2_, s1, (float)(p_237679_3_ + 2), (float)(p_237679_4_ + 12), 13413468);
   ...
   class TrialServerEntry extends RealmsMainScreen.ListEntry {
      ...
      private void func_237681_a_(MatrixStack p_237681_1_, int p_237681_2_, int p_237681_3_, int p_237681_4_, int p_237681_5_, int p_237681_6_) {
         ...
         for(String s1 : s.split("\\\\n")) {
            RealmsMainScreen.this.func_238471_a_(p_237681_1_, RealmsMainScreen.this.field_230712_o_, s1, RealmsMainScreen.this.field_230708_k_ / 2, i + j, k);
            j += 10;
         }
