...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen implements IErrorConsumer {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238471_a_(p_230430_1_, this.field_230712_o_, this.field_224243_g, this.field_230708_k_ / 2, func_239562_k_(3), 16777215);
      if (!this.field_224244_h) {
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, field_224237_a[this.field_224247_k % field_224237_a.length], this.field_230708_k_ / 2, func_239562_k_(8), 8421504);
      }

      if (this.field_224244_h) {
         this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224245_i, this.field_230708_k_ / 2, func_239562_k_(8), 16711680);
      }
