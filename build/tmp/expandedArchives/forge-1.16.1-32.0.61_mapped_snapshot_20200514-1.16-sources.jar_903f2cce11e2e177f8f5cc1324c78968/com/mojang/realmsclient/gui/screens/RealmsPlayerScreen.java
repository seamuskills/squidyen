...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (this.field_224303_d != null && this.field_224303_d.field_230589_h_ != null) {
         this.field_230712_o_.func_238421_b_(p_230430_1_, I18n.format("mco.configure.world.invited") + " (" + this.field_224303_d.field_230589_h_.size() + ")", (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      } else {
         this.field_230712_o_.func_238421_b_(p_230430_1_, I18n.format("mco.configure.world.invited"), (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      }
   ...
   protected void func_237903_a_(MatrixStack p_237903_1_, String p_237903_2_, int p_237903_3_, int p_237903_4_) {
      if (p_237903_2_ != null) {
         ...
         int k = this.field_230712_o_.getStringWidth(p_237903_2_);
         this.func_238468_a_(p_237903_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
         this.field_230712_o_.func_238405_a_(p_237903_1_, p_237903_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   class InvitedEntry extends ExtendedList.AbstractListEntry<RealmsPlayerScreen.InvitedEntry> {
      ...
      private void func_237932_a_(MatrixStack p_237932_1_, PlayerInfo p_237932_2_, int p_237932_3_, int p_237932_4_, int p_237932_5_, int p_237932_6_) {
         ...
         RealmsPlayerScreen.this.field_230712_o_.func_238421_b_(p_237932_1_, I18n.format("mco.configure.world.activityfeed.disabled"), (float)RealmsPlayerScreen.this.field_224307_h, (float)RealmsPlayerScreen.func_239562_k_(5), 10526880);
