...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224178_d, this.field_230708_k_ / 2, 20, 16777215);
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224184_j, this.field_230708_k_ / 2, 50, 16777215);
      ...
      if (this.field_224183_i != null) {
         this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224183_i, this.field_230708_k_ / 2, 110, 16711680);
      }
   ...
   private void func_237836_c_(MatrixStack p_237836_1_) {
      ...
      this.func_238471_a_(p_237836_1_, this.field_230712_o_, this.field_224185_k + " %", this.field_230708_k_ / 2, 84, 16777215);
   }
