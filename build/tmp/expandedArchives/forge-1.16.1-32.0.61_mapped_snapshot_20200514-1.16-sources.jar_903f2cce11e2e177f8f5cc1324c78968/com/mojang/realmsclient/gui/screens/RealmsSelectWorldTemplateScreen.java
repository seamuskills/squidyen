...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224519_e, this.field_230708_k_ / 2, 13, 16777215);
      if (this.field_224529_o) {
         ...
         for(int i1 = 0; i1 < aitextcomponent.length; ++i1) {
            ...
            this.func_238472_a_(p_230430_1_, this.field_230712_o_, itextcomponent, this.field_230708_k_ / 2, func_239562_k_(-1 + i1), j1);
         }
      }
   ...
   protected void func_237993_a_(MatrixStack p_237993_1_, String p_237993_2_, int p_237993_3_, int p_237993_4_) {
      if (p_237993_2_ != null) {
         ...
         int k = this.field_230712_o_.getStringWidth(p_237993_2_);
         this.func_238468_a_(p_237993_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
         this.field_230712_o_.func_238405_a_(p_237993_1_, p_237993_2_, (float)i, (float)j, 16777215);
      }
   }
