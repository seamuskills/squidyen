...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void func_231160_c_() {
      ...
      this.field_224710_o = new Button(this.field_230708_k_ / 2 - 100, this.field_230709_l_ - 42, 200, 20, DialogTexts.field_240637_h_, (p_238087_1_) -> {
         this.func_224679_c();
      });
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224704_i, this.field_230708_k_ / 2, 50, 16777215);
      if (this.field_224708_m) {
      ...
      if (this.field_224703_h != null) {
         for(int i = 0; i < this.field_224703_h.length; ++i) {
            this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224703_h[i], this.field_230708_k_ / 2, 110 + 12 * i, 16711680);
         }
      }
   ...
   private void func_238088_c_(MatrixStack p_238088_1_) {
      ...
      this.func_238471_a_(p_238088_1_, this.field_230712_o_, this.field_224705_j + " %", this.field_230708_k_ / 2, 84, 16777215);
   }
