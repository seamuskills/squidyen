...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238471_a_(p_230430_1_, this.field_230712_o_, "Changes from last backup", this.field_230708_k_ / 2, 10, 16777215);
   ...
   class BackupInfoEntry extends ExtendedList.AbstractListEntry<RealmsBackupInfoScreen.BackupInfoEntry> {
      ...
      public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
         ...
         RealmsBackupInfoScreen.this.func_238476_c_(p_230432_1_, fontrenderer, this.field_237738_b_, p_230432_4_, p_230432_3_, 10526880);
         RealmsBackupInfoScreen.this.func_238475_b_(p_230432_1_, fontrenderer, RealmsBackupInfoScreen.this.func_237733_a_(this.field_237738_b_, this.field_237739_c_), p_230432_4_, p_230432_3_ + 12, 16777215);
      }
   }
