...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (this.field_224337_e.func_230965_k_() == 0 && this.field_224336_d) {
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, I18n.format("mco.invites.nopending"), this.field_230708_k_ / 2, this.field_230709_l_ / 2 - 20, 16777215);
      }
   ...
   protected void func_237866_a_(MatrixStack p_237866_1_, String p_237866_2_, int p_237866_3_, int p_237866_4_) {
      if (p_237866_2_ != null) {
         ...
         int k = this.field_230712_o_.getStringWidth(p_237866_2_);
         this.func_238468_a_(p_237866_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
         this.field_230712_o_.func_238405_a_(p_237866_1_, p_237866_2_, (float)i, (float)j, 16777215);
      }
   }
