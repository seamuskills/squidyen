...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238471_a_(p_230430_1_, this.field_230712_o_, I18n.format("mco.configure.worlds.title"), this.field_230708_k_ / 2, func_239562_k_(4), 16777215);
      super.func_230430_a_(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      if (this.field_224416_d == null) {
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, I18n.format("mco.configure.world.title"), this.field_230708_k_ / 2, 17, 16777215);
      } else {
         ...
         int k = this.field_230712_o_.getStringWidth(I18n.format("mco.configure.world.title"));
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, I18n.format("mco.configure.world.title"), this.field_230708_k_ / 2, 12, 16777215);
         this.func_238471_a_(p_230430_1_, this.field_230712_o_, s, this.field_230708_k_ / 2, 24, j);
         ...
         if (this.func_224376_g()) {
            this.field_230712_o_.func_238421_b_(p_230430_1_, I18n.format("mco.configure.current.minigame") + ": " + this.field_224416_d.func_230778_c_(), (float)(this.field_224418_f + 80 + 20 + 10), (float)func_239562_k_(13), 16777215);
         }
      ...
      (new Thread(() -> {
         ...
         try {
            ...
            this.field_230706_i_.execute(() -> {
               this.field_230706_i_.displayGuiScreen(new RealmsGenericErrorScreen(ITextComponent.func_241827_a_(realmsserviceexception.getMessage()), this.field_224415_c));
            });
         }
   ...
   protected void func_237796_a_(MatrixStack p_237796_1_, ITextComponent p_237796_2_, int p_237796_3_, int p_237796_4_) {
      ...
      this.field_230712_o_.func_238407_a_(p_237796_1_, p_237796_2_, (float)i, (float)j, 16777215);
   }
