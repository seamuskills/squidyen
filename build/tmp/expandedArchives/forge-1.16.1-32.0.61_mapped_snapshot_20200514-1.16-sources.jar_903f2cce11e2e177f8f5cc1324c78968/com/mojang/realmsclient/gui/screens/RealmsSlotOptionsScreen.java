...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   private ITextComponent func_224610_c() {
      return (new TranslationTextComponent("selectWorld.gameMode")).func_240702_b_(": ").func_230529_a_(field_238036_b_[this.field_224650_m]);
   }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_230712_o_.func_238421_b_(p_230430_1_, s, (float)(this.field_224643_f + this.field_224644_g / 2 - this.field_230712_o_.getStringWidth(s) / 2), (float)(func_239562_k_(0) - 5), 16777215);
