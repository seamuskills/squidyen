...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_230712_o_.func_238421_b_(p_230430_1_, I18n.format("mco.configure.world.backup"), (float)((this.field_230708_k_ - 150) / 2 - 90), 20.0F, 10526880);
      if (this.field_224125_l) {
         this.field_230712_o_.func_238421_b_(p_230430_1_, I18n.format("mco.backup.nobackups"), 20.0F, (float)(this.field_230709_l_ / 2 - 10), 16777215);
      }
   ...
   protected void func_237744_a_(MatrixStack p_237744_1_, String p_237744_2_, int p_237744_3_, int p_237744_4_) {
      if (p_237744_2_ != null) {
         ...
         int k = this.field_230712_o_.getStringWidth(p_237744_2_);
         this.func_238468_a_(p_237744_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
         this.field_230712_o_.func_238405_a_(p_237744_1_, p_237744_2_, (float)i, (float)j, 16777215);
      }
   }
