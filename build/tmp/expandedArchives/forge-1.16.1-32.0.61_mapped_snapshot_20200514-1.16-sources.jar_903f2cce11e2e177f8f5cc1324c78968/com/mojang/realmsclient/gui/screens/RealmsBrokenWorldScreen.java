...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_237769_r_, this.field_230708_k_ / 2, 17, 16777215);

      for(int i = 0; i < this.field_224077_g.length; ++i) {
         this.func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224077_g[i], this.field_230708_k_ / 2, func_239562_k_(-1) + 3 + i * 12, 10526880);
      }
   ...
   private void func_224068_a(long p_224068_1_) {
      (new Thread(() -> {
         ...
         try {
            ...
            this.field_230706_i_.displayGuiScreen(new RealmsGenericErrorScreen(ITextComponent.func_241827_a_(realmsserviceexception.getMessage()), this.field_224072_b));
         }
   ...
   private void func_237775_a_(MatrixStack p_237775_1_, int p_237775_2_, int p_237775_3_, int p_237775_4_, int p_237775_5_, boolean p_237775_6_, String p_237775_7_, int p_237775_8_, long p_237775_9_, String p_237775_11_, boolean p_237775_12_) {
      ...
      this.func_238471_a_(p_237775_1_, this.field_230712_o_, p_237775_7_, p_237775_2_ + 40, p_237775_3_ + 66, 16777215);
   }
}
