...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_230712_o_.func_238421_b_(p_230430_1_, I18n.format("mco.configure.world.name"), (float)(this.field_230708_k_ / 2 - 100), 52.0F, 10526880);
      this.field_230712_o_.func_238421_b_(p_230430_1_, I18n.format("mco.configure.world.description"), (float)(this.field_230708_k_ / 2 - 100), 102.0F, 10526880);
      if (this.field_224137_c != null) {
