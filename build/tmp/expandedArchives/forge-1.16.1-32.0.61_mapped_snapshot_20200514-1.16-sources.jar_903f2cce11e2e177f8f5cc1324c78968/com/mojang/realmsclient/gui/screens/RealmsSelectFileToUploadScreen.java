...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   public void func_231160_c_() {
      ...
      try {
         ...
         this.field_230706_i_.displayGuiScreen(new RealmsGenericErrorScreen(new StringTextComponent("Unable to load worlds"), ITextComponent.func_241827_a_(exception.getMessage()), this.field_224548_b));
         return;
      }
   ...
   class WorldSelectionEntry extends ExtendedList.AbstractListEntry<RealmsSelectFileToUploadScreen.WorldSelectionEntry> {
      ...
      protected void func_237985_a_(MatrixStack p_237985_1_, WorldSummary p_237985_2_, int p_237985_3_, int p_237985_4_, int p_237985_5_) {
         ...
         RealmsSelectFileToUploadScreen.this.field_230712_o_.func_238421_b_(p_237985_1_, s1, (float)(p_237985_4_ + 2), (float)(p_237985_5_ + 12), 8421504);
         RealmsSelectFileToUploadScreen.this.field_230712_o_.func_238421_b_(p_237985_1_, s2, (float)(p_237985_4_ + 2), (float)(p_237985_5_ + 12 + 10), 8421504);
      }
   }
